...
import { Trash, EllipsisHorizontal, PencilSquare, Photo } from "@medusajs/icons";
import { FocusModal, Button, Heading, Label, Input, Text, Badge, Select, Switch, Checkbox, toast, usePrompt, DropdownMenu, IconButton, createDataTableColumnHelper, StatusBadge, useDataTable, Container, DataTable, Toaster } from "@medusajs/ui";
...
const useShopByLook = (lookId, options) => useQuery({
...
const ShopByLookFormDrawer = ({ look, open, onOpenChange }) => {
  ...
  const [placement, setPlacement] = useState("after_featured");
  ...
  return /* @__PURE__ */ jsx(FocusModal, { open, onOpenChange, children: /* @__PURE__ */ jsxs(FocusModal.Content, { children: [
    /* @__PURE__ */ jsxs(FocusModal.Header, { children: [
      /* @__PURE__ */ jsx(FocusModal.Title, { asChild: true, children: /* @__PURE__ */ jsx("span", { className: "sr-only", children: isEdit ? t("EDIT_TITLE") : t("CREATE_TITLE") }) }),
      /* @__PURE__ */ jsxs("div", { className: "flex w-full items-center justify-end gap-x-2", children: [
        /* @__PURE__ */ jsx(Button, { variant: "secondary", size: "small", onClick: () => onOpenChange(false), children: t("CANCEL") }),
        /* @__PURE__ */ jsx(Button, { size: "small", onClick: handleSubmit, isLoading: isPending, children: isEdit ? t("SAVE_CHANGES") : t("CREATE_SUBMIT") })
      ] })
    ] }),
    /* @__PURE__ */ jsxs(FocusModal.Body, { className: "flex flex-1 overflow-hidden", children: [
      /* @__PURE__ */ jsx("div", { className: "flex-1 overflow-y-auto px-8 py-10", children: /* @__PURE__ */ jsxs("div", { className: "mx-auto flex w-full max-w-[640px] flex-col gap-8", children: [
        /* @__PURE__ */ jsx(Heading, { children: isEdit ? t("EDIT_TITLE") : t("CREATE_TITLE") }),
        /* @__PURE__ */ jsxs("div", { className: "flex flex-col gap-4", children: [
          /* @__PURE__ */ jsxs("div", { className: "flex flex-col gap-1", children: [
            /* @__PURE__ */ jsx(Label, { size: "xsmall", children: t("FIELD_TITLE_LABEL") }),
            /* @__PURE__ */ jsx(
              Input,
              {
          ...
          /* @__PURE__ */ jsxs("div", { className: "flex flex-col gap-1", children: [
            /* @__PURE__ */ jsx(Label, { size: "xsmall", children: t("FIELD_SUBTITLE_LABEL") }),
            /* @__PURE__ */ jsx(
              Input,
              {
        ...
        /* @__PURE__ */ jsxs("div", { className: "flex flex-col gap-2 border-t pt-6", children: [
          /* @__PURE__ */ jsx(Label, { size: "xsmall", children: t("FIELD_IMAGE_LABEL") }),
          /* @__PURE__ */ jsx(
            "input",
            {
              ref: fileInputRef,
        ...
        /* @__PURE__ */ jsxs("div", { className: "flex flex-col gap-3 border-t pt-6", children: [
          /* @__PURE__ */ jsxs("div", { children: [
            /* @__PURE__ */ jsx(Heading, { level: "h3", children: t("PRODUCTS_TITLE") }),
            /* @__PURE__ */ jsx(Text, { size: "small", className: "text-ui-fg-subtle", children: t("PRODUCTS_CLICK_HELP") })
          ] }),
          /* @__PURE__ */ jsxs("div", { className: "relative", children: [
            ...
            debounced.length >= 2 && searchResults.length > 0 && /* @__PURE__ */ jsx("div", { className: "absolute z-10 mt-1 w-full overflow-hidden rounded-lg border border-ui-border-base bg-ui-bg-base shadow-elevation-flyout", children: searchResults.map((p) => /* @__PURE__ */ jsxs(
              "button",
              {
                type: "button",
            ...
            debounced.length >= 2 && searchResults.length === 0 && /* @__PURE__ */ jsx(Text, { size: "xsmall", className: "mt-1 text-ui-fg-muted", children: t("NO_PRODUCTS_FOUND", { query: debounced }) })
          ] }),
          rows.length === 0 ? /* @__PURE__ */ jsx(Text, { size: "small", className: "text-ui-fg-subtle", children: t("NO_PRODUCTS") }) : /* @__PURE__ */ jsx("ul", { className: "flex flex-col gap-2", children: rows.map((row, i) => {
              ...
              "li",
              {
                ...
                children: [
                  /* @__PURE__ */ jsxs("div", { className: "flex items-center gap-3", children: [
                    /* @__PURE__ */ jsx("span", { className: "flex h-6 w-6 shrink-0 items-center justify-center rounded-full bg-ui-bg-component text-xs font-semibold", children: i + 1 }),
                    /* @__PURE__ */ jsx(Thumb, { src: row.thumbnail }),
                    /* @__PURE__ */ jsx(Text, { size: "small", className: "flex-1 truncate", children: row.title }),
                    active && /* @__PURE__ */ jsx(Badge, { size: "2xsmall", color: "blue", children: t("PLACING_BADGE") }),
                    /* @__PURE__ */ jsx(
                      Button,
                      {
                        type: "button",
                  ...
                  showVariant && /* @__PURE__ */ jsx("div", { onClick: (e) => e.stopPropagation(), children: /* @__PURE__ */ jsxs(
                    Select,
                    {
                      ...
                      children: [
                        /* @__PURE__ */ jsx(Select.Trigger, { children: /* @__PURE__ */ jsx(Select.Value, { placeholder: t("VARIANT_ANY") }) }),
                        /* @__PURE__ */ jsxs(Select.Content, { children: [
                          /* @__PURE__ */ jsx(Select.Item, { value: VARIANT_ANY, children: t("VARIANT_ANY") }),
                          row.variants.map((v) => /* @__PURE__ */ jsx(Select.Item, { value: v.id, children: v.title || v.id }, v.id))
                        ] })
                      ]
                    }
                  ) })
        ...
        /* @__PURE__ */ jsxs("div", { className: "flex flex-col gap-4 border-t pt-6", children: [
          /* @__PURE__ */ jsxs("div", { className: "flex flex-col gap-1", children: [
            /* @__PURE__ */ jsx(Label, { size: "xsmall", children: t("FIELD_PLACEMENT_LABEL") }),
            /* @__PURE__ */ jsxs(
              Select,
              {
                value: placement,
                ...
                children: [
                  ...
                  /* @__PURE__ */ jsx(Select.Content, { children: PLACEMENTS.map((p) => /* @__PURE__ */ jsx(Select.Item, { value: p, children: t(PLACEMENT_LABEL_KEY$1[p]) }, p)) })
                ]
              }
            )
          ] }),
          /* @__PURE__ */ jsxs("div", { className: "flex items-center justify-between", children: [
            /* @__PURE__ */ jsxs("div", { children: [
              /* @__PURE__ */ jsx(Label, { size: "xsmall", children: t("FIELD_ACTIVE_LABEL") }),
              /* @__PURE__ */ jsx(Text, { size: "xsmall", className: "text-ui-fg-subtle", children: t("FIELD_ACTIVE_HELP") })
            ] }),
            /* @__PURE__ */ jsx(Switch, { checked: isActive, onCheckedChange: setIsActive })
          ] }),
          /* @__PURE__ */ jsxs("div", { className: "flex flex-col gap-1", children: [
            /* @__PURE__ */ jsx(Label, { size: "xsmall", children: t("FIELD_SORT_ORDER_LABEL") }),
            /* @__PURE__ */ jsx(
              Input,
              {
                type: "number",
        ...
        /* @__PURE__ */ jsxs("div", { className: "flex flex-col gap-4 border-t pt-6", children: [
          /* @__PURE__ */ jsxs("div", { className: "flex flex-col gap-2", children: [
            /* @__PURE__ */ jsx(Label, { size: "xsmall", children: t("FIELD_SALES_CHANNELS_LABEL") }),
            /* @__PURE__ */ jsx(Text, { size: "xsmall", className: "text-ui-fg-subtle", children: t("FIELD_SALES_CHANNELS_HELP") }),
          ...
          /* @__PURE__ */ jsxs("div", { className: "flex flex-col gap-2", children: [
            /* @__PURE__ */ jsx(Label, { size: "xsmall", children: t("FIELD_REGIONS_LABEL") }),
            /* @__PURE__ */ jsx(Text, { size: "xsmall", className: "text-ui-fg-subtle", children: t("FIELD_REGIONS_HELP") }),
            /* @__PURE__ */ jsx("div", { className: "flex flex-col gap-2", children: regions.map((r) => /* @__PURE__ */ jsxs("label", { className: "flex items-center gap-2", children: [
              /* @__PURE__ */ jsx(
                Checkbox,
                {
              ...
              /* @__PURE__ */ jsx(Text, { size: "small", children: r.name })
            ] }, r.id)) })
          ] })
        ] })
      ] }) }),
      /* @__PURE__ */ jsxs("aside", { className: "hidden w-[460px] shrink-0 flex-col gap-3 overflow-y-auto border-l border-ui-border-base bg-ui-bg-subtle px-6 py-6 lg:flex", children: [
        /* @__PURE__ */ jsxs("div", { className: "flex flex-col gap-1", children: [
          /* @__PURE__ */ jsx(Label, { className: "font-semibold text-ui-fg-base", children: t("PREVIEW_TITLE") }),
          /* @__PURE__ */ jsx(Text, { size: "xsmall", className: "text-ui-fg-subtle", children: placingId ? t("PLACE_HINT") : t("PLACE_HINT_SELECT") })
        ] }),
        ...
        ) : /* @__PURE__ */ jsx("div", { className: "flex h-64 items-center justify-center rounded-xl border border-dashed border-ui-border-base", children: /* @__PURE__ */ jsx(Text, { size: "small", className: "text-ui-fg-muted", children: t("PREVIEW_EMPTY") }) })
      ] })
    ] })
  ] }) });
};
...
const ShopByLookActionsMenu = ({ look }) => {
  ...
  return /* @__PURE__ */ jsxs(Fragment, { children: [
    ...
    /* @__PURE__ */ jsx(ShopByLookFormDrawer, { look, open: editOpen, onOpenChange: setEditOpen })
  ] });
};
const ShopByLookCreateButton = () => {
  ...
  return /* @__PURE__ */ jsxs(Fragment, { children: [
    /* @__PURE__ */ jsx(Button, { variant: "secondary", size: "small", onClick: () => setOpen(true), children: t("CREATE_BUTTON") }),
    /* @__PURE__ */ jsx(ShopByLookFormDrawer, { look: null, open, onOpenChange: setOpen })
  ] });
};
...
const GlobalToggle = () => {
  ...
  return /* @__PURE__ */ jsxs("div", { className: "flex items-center gap-2", title: t("GLOBAL_TOGGLE_HELP"), children: [
    /* @__PURE__ */ jsx(Text, { size: "small", className: "text-ui-fg-subtle", children: t("GLOBAL_TOGGLE_LABEL") }),
    /* @__PURE__ */ jsx(
      Switch,
      {
        checked: enabled,
  ...
  const columns = useMemo(
    () => [
      ...
      columnHelper.accessor("placement", {
        ...
        cell: ({ getValue }) => /* @__PURE__ */ jsx("span", { className: "text-ui-fg-subtle", children: t(PLACEMENT_LABEL_KEY[getValue()] ?? "PLACEMENT_AFTER_FEATURED") })
      }),
      columnHelper.display({
        ...
        cell: ({ row }) => {
          var _a;
          return /* @__PURE__ */ jsx("span", { className: "text-ui-fg-subtle", children: ((_a = row.original.products) == null ? void 0 : _a.length) ?? 0 });
        }
      }),
      ...
      columnHelper.display({
        ...
        cell: ({ row }) => /* @__PURE__ */ jsx("div", { onClick: (e) => e.stopPropagation(), children: /* @__PURE__ */ jsx(ShopByLookActionsMenu, { look: row.original }) })
      })
    ],
    [t]
  );
    ...
    /* @__PURE__ */ jsx(Container, { className: "p-0", children: /* @__PURE__ */ jsxs(DataTable, { instance: table, children: [
      /* @__PURE__ */ jsxs(DataTable.Toolbar, { className: "flex items-center justify-between px-6 py-4", children: [
        /* @__PURE__ */ jsxs("div", { className: "flex items-center gap-x-2", children: [
          ...
          /* @__PURE__ */ jsx(ExtensionVersion, { extension: "shop-by-looks" })
        ] }),
        /* @__PURE__ */ jsxs("div", { className: "flex items-center gap-4", children: [
          /* @__PURE__ */ jsx(GlobalToggle, {}),
          /* @__PURE__ */ jsx(DataTable.Search, { placeholder: t("SEARCH_PLACEHOLDER") }),
          /* @__PURE__ */ jsx(ShopByLookCreateButton, {})
        ] })
      ] }),
      /* @__PURE__ */ jsx(SiteScopeBar, { screen: "shop-by-looks" }),
...
const ShopByLookIcon = () => /* @__PURE__ */ jsx(Photo, { style: { color: "#7270F5" } });
