...
export function loadDisplayImage(url: string): Promise<HTMLImageElement> {
 ...
 */
export function loadExportImage(url: string): Promise<HTMLImageElement> {
...
export function centerCrop(img: HTMLImageElement, aspect: number | null): PixelRect {
...
export type ExportResult = { file: File; width: number; height: number; bytes: number };
