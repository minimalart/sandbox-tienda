...
import { EllipsisHorizontal, PencilSquare, SquareTwoStack, Trash, ShoppingCart } from "@medusajs/icons";
import { usePrompt, DropdownMenu, IconButton, toast, FocusModal, Button, Text, Label, Input, ProgressTabs, Select, Switch, DatePicker, createDataTableColumnHelper, Badge, StatusBadge, useDataTable, Container, DataTable, Heading, Toaster } from "@medusajs/ui";
import { useState, useMemo, useEffect } from "react";
import { useQuery, useQueryClient, useMutation } from "@tanstack/react-query";
import { ExtensionVersion, SiteScopeBar, ExtensionSettingsCard } from "@minimalart/mercatto-plugin-runtime/admin";
...
function CheckoutLinkActionsMenu({ link, onEdit }) {
  ...
  function toggleDisabled() {
    update.mutate(
      ...
      {
        onSuccess: () => toast.success(isDisabled ? "Link reactivado" : "Link deshabilitado"),
  ...
  return /* @__PURE__ */ jsxs(DropdownMenu, { children: [
    ...
    /* @__PURE__ */ jsxs(DropdownMenu.Content, { children: [
      /* @__PURE__ */ jsxs(DropdownMenu.Item, { className: "gap-x-2", onClick: onEdit, children: [
        /* @__PURE__ */ jsx(PencilSquare, { className: "text-ui-fg-subtle" }),
        "Ver / Editar"
      ] }),
      /* @__PURE__ */ jsxs(DropdownMenu.Item, { className: "gap-x-2", onClick: copyUrl, children: [
        /* @__PURE__ */ jsx(SquareTwoStack, { className: "text-ui-fg-subtle" }),
        "Copiar URL"
      ] }),
      /* @__PURE__ */ jsxs(DropdownMenu.Item, { className: "gap-x-2", onClick: toggleDisabled, children: [
        /* @__PURE__ */ jsx(PencilSquare, { className: "text-ui-fg-subtle" }),
...
function CheckoutLinkFormModal({
  ...
  const [prefilledForId, setPrefilledForId] = useState(null);
  ...
  function handleSubmit() {
    ...
    if (isEdit) {
      update.mutate(
        ...
        },
        {
          ...
          onError: (e) => toast.error(e.message || "Error al actualizar el link")
        }
      );
      return;
    }
    create.mutate(
      ...
      },
      {
        ...
        onError: (e) => toast.error(e.message || "Error al crear el link")
      }
    );
  }
  ...
  return /* @__PURE__ */ jsx(FocusModal, { open, onOpenChange: handleClose, children: /* @__PURE__ */ jsx(FocusModal.Content, { children: createdUrl ? /* @__PURE__ */ jsxs(Fragment, { children: [
    /* @__PURE__ */ jsx(FocusModal.Header, { children: /* @__PURE__ */ jsx("div", { className: "flex items-center justify-end gap-x-2", children: /* @__PURE__ */ jsx(Button, { size: "small", variant: "secondary", onClick: () => handleClose(false), children: "Cerrar" }) }) }),
    /* @__PURE__ */ jsx(FocusModal.Body, { className: "flex flex-col items-center overflow-y-auto py-12", children: /* @__PURE__ */ jsxs("div", { className: "flex w-full max-w-xl flex-col gap-y-4", children: [
      /* @__PURE__ */ jsx(Text, { size: "large", weight: "plus", children: "¡Link de venta creado!" }),
      /* @__PURE__ */ jsx(Label, { children: "URL pública" }),
      /* @__PURE__ */ jsxs("div", { className: "flex items-center gap-x-2", children: [
        /* @__PURE__ */ jsx(Input, { value: createdUrl, readOnly: true }),
        /* @__PURE__ */ jsx(Button, { variant: "primary", onClick: () => copyUrl(createdUrl), children: "Copiar" })
      ] }),
      /* @__PURE__ */ jsx(Text, { size: "small", className: "text-ui-fg-subtle", children: "Compartí este enlace: el cliente abrirá un carrito ya armado y avanzará directo hacia el pago." })
    ] }) })
  ] }) : /* @__PURE__ */ jsxs(
    ProgressTabs,
    {
      ...
      children: [
        /* @__PURE__ */ jsx(FocusModal.Header, { className: "flex items-center gap-4", children: /* @__PURE__ */ jsx("div", { className: "-my-2 w-full border-l", children: /* @__PURE__ */ jsx(ProgressTabs.List, { children: TABS.map((tab, index) => /* @__PURE__ */ jsx(
        ...
        /* @__PURE__ */ jsx(FocusModal.Body, { className: "flex flex-1 justify-center overflow-y-auto", children: /* @__PURE__ */ jsxs("div", { className: "w-full max-w-2xl px-6 py-10", children: [
          /* @__PURE__ */ jsxs(ProgressTabs.Content, { value: "general", className: "flex flex-col gap-y-6", children: [
            /* @__PURE__ */ jsxs("div", { children: [
              /* @__PURE__ */ jsx(Text, { size: "large", weight: "plus", children: isEdit ? "Editar link de venta" : "Nuevo link de venta" }),
              /* @__PURE__ */ jsx(Text, { size: "small", className: "text-ui-fg-subtle", children: "Generá una URL pública con un carrito precargado." })
            ] }),
            isEdit && publicUrl && /* @__PURE__ */ jsxs("div", { className: "flex flex-col gap-y-2 rounded-lg border border-ui-border-base bg-ui-bg-subtle p-3", children: [
              /* @__PURE__ */ jsx(Label, { children: "URL pública" }),
              /* @__PURE__ */ jsxs("div", { className: "flex items-center gap-x-2", children: [
                /* @__PURE__ */ jsx(Input, { value: publicUrl, readOnly: true }),
                /* @__PURE__ */ jsx(Button, { variant: "secondary", onClick: () => copyUrl(publicUrl), children: "Copiar" })
              ] })
            ] }),
            /* @__PURE__ */ jsxs("div", { className: "flex flex-col gap-y-2", children: [
              /* @__PURE__ */ jsx(Label, { children: "Nombre interno (opcional)" }),
              /* @__PURE__ */ jsx(
                Input,
                {
            ...
            /* @__PURE__ */ jsxs("div", { className: "flex flex-col gap-y-2", children: [
              /* @__PURE__ */ jsx(Label, { children: "País / región" }),
              /* @__PURE__ */ jsxs(
                Select,
                {
                  value: countryCode,
                  ...
                  children: [
                    /* @__PURE__ */ jsx(Select.Trigger, { children: /* @__PURE__ */ jsx(Select.Value, { placeholder: "Elegí un país" }) }),
                    /* @__PURE__ */ jsx(Select.Content, { children: countryOptions.map((o) => /* @__PURE__ */ jsx(Select.Item, { value: o.iso_2, children: o.label }, o.iso_2)) })
                  ]
                }
              )
            ] }),
            salesChannels.length > 0 && /* @__PURE__ */ jsxs("div", { className: "flex flex-col gap-y-2", children: [
              /* @__PURE__ */ jsx(Label, { children: "Canal de venta (B2C)" }),
              /* @__PURE__ */ jsxs(Select, { value: salesChannelId, onValueChange: setSalesChannelId, children: [
                /* @__PURE__ */ jsx(Select.Trigger, { children: /* @__PURE__ */ jsx(Select.Value, { placeholder: "Elegí un canal" }) }),
                /* @__PURE__ */ jsx(Select.Content, { children: salesChannels.map((sc) => /* @__PURE__ */ jsx(Select.Item, { value: sc.id, children: sc.name }, sc.id)) })
              ] })
            ] })
          ] }),
          /* @__PURE__ */ jsxs(ProgressTabs.Content, { value: "items", className: "flex flex-col gap-y-4", children: [
            /* @__PURE__ */ jsx(Label, { children: "Productos" }),
            /* @__PURE__ */ jsx(
              Input,
              {
            ...
            search.trim().length > 1 && /* @__PURE__ */ jsx("div", { className: "max-h-56 overflow-y-auto rounded-lg border border-ui-border-base", children: searching ? /* @__PURE__ */ jsx(Text, { size: "small", className: "p-3 text-ui-fg-subtle", children: "Buscando…" }) : products.length === 0 ? /* @__PURE__ */ jsx(Text, { size: "small", className: "p-3 text-ui-fg-subtle", children: "Sin resultados" }) : products.map((p) => /* @__PURE__ */ jsxs(
              "div",
              {
                className: "border-ui-border-base border-b p-2 last:border-b-0",
                children: [
                  /* @__PURE__ */ jsx(Text, { size: "small", weight: "plus", children: p.title }),
                  /* @__PURE__ */ jsx("div", { className: "mt-1 flex flex-wrap gap-1", children: (p.variants ?? []).map((v) => /* @__PURE__ */ jsxs(
                    Button,
                    {
                      size: "small",
                      variant: "transparent",
            ...
            items.length > 0 && /* @__PURE__ */ jsx("div", { className: "flex flex-col gap-y-2 rounded-lg border border-ui-border-base p-3", children: items.map((i) => /* @__PURE__ */ jsxs(
              "div",
              {
                className: "flex items-center justify-between gap-x-2",
                children: [
                  /* @__PURE__ */ jsx(Text, { size: "small", className: "flex-1 truncate", children: variantLabels[i.variant_id] || `Variante ${i.variant_id.slice(-6)}` }),
                  /* @__PURE__ */ jsx(
                    Input,
                    {
                      type: "number",
          ...
          /* @__PURE__ */ jsxs(ProgressTabs.Content, { value: "customer", className: "flex flex-col gap-y-3", children: [
            ...
            customerMode === "existing" && (selectedCustomer ? /* @__PURE__ */ jsxs("div", { className: "flex flex-col gap-y-3 rounded-lg border border-ui-border-base p-3", children: [
              /* @__PURE__ */ jsxs("div", { className: "flex items-center justify-between gap-x-2", children: [
                /* @__PURE__ */ jsx(Text, { size: "small", weight: "plus", children: customerLabel(selectedCustomer) }),
                /* @__PURE__ */ jsx(Button, { size: "small", variant: "transparent", onClick: clearCustomer, children: "Cambiar" })
              ] }),
              (((_a = selectedCustomer.addresses) == null ? void 0 : _a.length) ?? 0) > 0 ? /* @__PURE__ */ jsxs("div", { className: "flex flex-col gap-y-1", children: [
                /* @__PURE__ */ jsx(Text, { size: "xsmall", className: "text-ui-fg-subtle", children: "Dirección a precargar" }),
                /* @__PURE__ */ jsx(
                  "button",
                  {
                    type: "button",
                ...
                (_b = selectedCustomer.addresses) == null ? void 0 : _b.map((a) => /* @__PURE__ */ jsx(
                  "button",
                  {
                    type: "button",
              ...
              ] }) : /* @__PURE__ */ jsx(Text, { size: "small", className: "text-ui-fg-subtle", children: "Este cliente no tiene direcciones guardadas." })
            ] }) : /* @__PURE__ */ jsxs("div", { className: "flex flex-col gap-y-2", children: [
              /* @__PURE__ */ jsx(
                Input,
                {
              ...
              customerSearch.trim().length > 1 && /* @__PURE__ */ jsx("div", { className: "max-h-56 overflow-y-auto rounded-lg border border-ui-border-base", children: customersLoading ? /* @__PURE__ */ jsx(Text, { size: "small", className: "p-3 text-ui-fg-subtle", children: "Buscando…" }) : ((customers == null ? void 0 : customers.length) ?? 0) === 0 ? /* @__PURE__ */ jsx(Text, { size: "small", className: "p-3 text-ui-fg-subtle", children: "Sin resultados" }) : customers == null ? void 0 : customers.map((c) => /* @__PURE__ */ jsx(
                "button",
                {
                  type: "button",
                  onClick: () => selectCustomer(c),
                  className: "block w-full border-ui-border-base border-b p-2 text-left last:border-b-0 hover:bg-ui-bg-subtle",
                  children: /* @__PURE__ */ jsx(Text, { size: "small", weight: "plus", children: customerLabel(c) })
                },
                c.id
              )) })
            ] })),
            customerMode === "new" && /* @__PURE__ */ jsxs(Fragment, { children: [
              /* @__PURE__ */ jsx(
                Input,
                {
                  type: "email",
              ...
              /* @__PURE__ */ jsxs("div", { className: "flex items-center justify-between", children: [
                /* @__PURE__ */ jsx(Text, { size: "small", children: "Precargar dirección de envío" }),
                /* @__PURE__ */ jsx(Switch, { checked: includeAddress, onCheckedChange: setIncludeAddress })
              ] }),
              includeAddress && /* @__PURE__ */ jsxs("div", { className: "grid grid-cols-2 gap-3 rounded-lg border border-ui-border-base p-3", children: [
                /* @__PURE__ */ jsx(
                  Input,
                  {
                    placeholder: "Nombre",
            ...
            customerMode === "none" && /* @__PURE__ */ jsx(Text, { size: "small", className: "text-ui-fg-subtle", children: "El cliente cargará sus datos en el checkout." })
          ] }),
          /* @__PURE__ */ jsxs(ProgressTabs.Content, { value: "options", className: "flex flex-col gap-y-6", children: [
            /* @__PURE__ */ jsxs("div", { className: "flex flex-col gap-y-2", children: [
              /* @__PURE__ */ jsx(Label, { children: "Códigos de promoción (opcional)" }),
              /* @__PURE__ */ jsx(
                Input,
                {
            ...
            /* @__PURE__ */ jsxs("div", { className: "grid grid-cols-2 gap-4", children: [
              /* @__PURE__ */ jsxs("div", { className: "flex flex-col gap-y-2", children: [
                /* @__PURE__ */ jsx(Label, { children: "Vence el (opcional)" }),
                /* @__PURE__ */ jsx(
                  DatePicker,
                  {
                    granularity: "minute",
              ...
              /* @__PURE__ */ jsxs("div", { className: "flex flex-col gap-y-2", children: [
                /* @__PURE__ */ jsx(Label, { children: "Un solo uso" }),
                /* @__PURE__ */ jsx("div", { className: "flex h-10 items-center", children: /* @__PURE__ */ jsx(Switch, { checked: singleUse, onCheckedChange: setSingleUse }) })
              ] })
            ] })
          ] })
        ] }) }),
        /* @__PURE__ */ jsx(FocusModal.Footer, { children: /* @__PURE__ */ jsxs("div", { className: "flex items-center justify-end gap-x-2", children: [
          ...
          isLastTab || isEdit ? /* @__PURE__ */ jsx(Button, { size: "small", onClick: handleSubmit, isLoading: isPending, children: isEdit ? "Guardar" : "Generar link" }) : /* @__PURE__ */ jsx(
            Button,
            {
              size: "small",
              type: "button",
...
const SalesLinksPage = () => {
  ...
  const links = useMemo(() => (data == null ? void 0 : data.checkout_links) ?? [], [data == null ? void 0 : data.checkout_links]);
  const count = (data == null ? void 0 : data.count) ?? 0;
  const columns = useMemo(
    () => [
      columnHelper.accessor("internal_name", {
        header: "Nombre",
        cell: ({ row }) => /* @__PURE__ */ jsx(Text, { size: "small", weight: "plus", children: row.original.internal_name || row.original.token })
      }),
      columnHelper.accessor("country_code", {
        header: "País",
        cell: ({ getValue }) => /* @__PURE__ */ jsx(Text, { size: "small", className: "uppercase text-ui-fg-subtle", children: getValue() })
      }),
      columnHelper.display({
        ...
        cell: ({ row }) => {
          var _a;
          return /* @__PURE__ */ jsx(Text, { size: "small", className: "text-ui-fg-subtle", children: ((_a = row.original.items) == null ? void 0 : _a.length) ?? 0 });
        }
      }),
      columnHelper.display({
        id: "flags",
        ...
        cell: ({ row }) => {
          ...
          return /* @__PURE__ */ jsxs("div", { className: "flex gap-1", children: [
            row.original.email ? /* @__PURE__ */ jsx(Badge, { size: "2xsmall", color: "blue", children: "email" }) : null,
            row.original.shipping_address ? /* @__PURE__ */ jsx(Badge, { size: "2xsmall", color: "purple", children: "dirección" }) : null,
            ((_a = row.original.promo_codes) == null ? void 0 : _a.length) ? /* @__PURE__ */ jsx(Badge, { size: "2xsmall", color: "green", children: "promo" }) : null,
            row.original.single_use ? /* @__PURE__ */ jsx(Badge, { size: "2xsmall", color: "orange", children: "1 uso" }) : null
          ] });
        }
      }),
      columnHelper.accessor("used_count", {
        header: "Usos",
        cell: ({ getValue }) => /* @__PURE__ */ jsx(Text, { size: "small", className: "text-ui-fg-subtle", children: getValue() ?? 0 })
      }),
      columnHelper.display({
        id: "status",
        header: "Estado",
      ...
      columnHelper.display({
        id: "actions",
        header: "",
        cell: ({ row }) => /* @__PURE__ */ jsx("div", { className: "flex justify-end", onClick: (e) => e.stopPropagation(), children: /* @__PURE__ */ jsx(
  ...
  return /* @__PURE__ */ jsxs(Fragment, { children: [
    /* @__PURE__ */ jsx(Container, { className: "p-0", children: /* @__PURE__ */ jsxs(DataTable, { instance: table, children: [
      /* @__PURE__ */ jsxs(DataTable.Toolbar, { className: "flex items-center justify-between px-6 py-4", children: [
        /* @__PURE__ */ jsxs("div", { className: "flex items-center gap-x-2", children: [
          /* @__PURE__ */ jsx(Heading, { children: "Links de Venta" }),
          /* @__PURE__ */ jsx(ExtensionVersion, { extension: "checkout-links" })
        ] }),
        /* @__PURE__ */ jsx(Button, { size: "small", variant: "secondary", onClick: () => setCreateOpen(true), children: "Crear link" })
      ] }),
      /* @__PURE__ */ jsx(SiteScopeBar, { screen: "checkout-links" }),
    ...
    /* @__PURE__ */ jsx(CheckoutLinkFormModal, { open: createOpen, onOpenChange: setCreateOpen }),
...
const SalesLinksIcon = () => /* @__PURE__ */ jsx(ShoppingCart, { style: { color: "#4B8EEF" } });
