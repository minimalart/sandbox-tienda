...
export type StoreConfigAiConfig = {
  ...
  // Required por optimizeToWebp — el host store-config siempre los provee con
  // default (quality 82, maxKb 500). Marcarlos required acá evita chequeos ??
  // en cada call site que serían pura ceremonia.
