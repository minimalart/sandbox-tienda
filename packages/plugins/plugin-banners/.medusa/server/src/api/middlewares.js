...
/**
 * Root middleware registry for the banners plugin.
 *
 ...
 * spreads them.
 *
 * The banners routes do NOT use `validateAndTransformBody`; each handler parses
 * the body inline via zod, so there is nothing to register here today. The file
