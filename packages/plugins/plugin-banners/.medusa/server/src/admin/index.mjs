...
import { DotsSix, Trash, Newspaper, EllipsisHorizontal, PencilSquare, SquareTwoStack, Photo, ArchiveBox, ArrowLeft } from "@medusajs/icons";
import { Text, FocusModal, ProgressTabs, Heading, Badge, Label, Button, toast, Checkbox, DatePicker, Select, Input, Textarea, Switch, clx, Drawer, Container, StatusBadge, Toaster, createDataTableColumnHelper, useDataTable, DataTable, DropdownMenu, IconButton } from "@medusajs/ui";
...
const CtaChip = ({ label }) => label ? /* @__PURE__ */ jsx("span", { className: "inline-flex shrink-0 items-center rounded-md bg-white px-2.5 py-1 text-xs font-medium text-zinc-900", children: label }) : null;
const TopBarPreview = ({ data }) => /* @__PURE__ */ jsxs(
  "div",
  {
    ...
    children: [
      ...
      /* @__PURE__ */ jsx(Text, { size: "small", className: "truncate text-inherit", children: data.title || data.body || "—" })
    ]
  }
);
const HeroPreview = ({ data }) => /* @__PURE__ */ jsxs("div", { className: "relative aspect-[21/9] w-full overflow-hidden rounded-lg bg-zinc-800", children: [
  data.mediaUrl ? /* @__PURE__ */ jsx("img", { src: data.mediaUrl, className: "absolute inset-0 h-full w-full object-cover" }) : null,
  /* @__PURE__ */ jsx("div", { className: "absolute inset-0 bg-gradient-to-r from-black/70 via-black/25 to-transparent" }),
  /* @__PURE__ */ jsxs("div", { className: "absolute inset-0 flex flex-col justify-center gap-1.5 p-6", children: [
    data.title ? /* @__PURE__ */ jsx("span", { className: "max-w-[70%] text-xl font-bold leading-tight text-white", children: data.title }) : null,
    data.subtitle ? /* @__PURE__ */ jsx("span", { className: "max-w-[70%] text-sm font-medium text-white/90", children: data.subtitle }) : null,
    data.body ? /* @__PURE__ */ jsx("span", { className: "line-clamp-2 max-w-[60%] text-xs text-white/75", children: data.body }) : null,
    data.ctaUrl ? /* @__PURE__ */ jsx("div", { className: "mt-2", children: /* @__PURE__ */ jsx(CtaChip, { label: data.ctaLabel || data.ctaUrl }) }) : null
  ] })
] });
const CardPreview = ({ data }) => /* @__PURE__ */ jsxs(
  "div",
  {
    ...
    children: [
      data.mediaUrl ? /* @__PURE__ */ jsx("img", { src: data.mediaUrl, className: "aspect-[16/7] w-full object-cover" }) : /* @__PURE__ */ jsx("div", { className: "aspect-[16/7] w-full bg-ui-bg-subtle" }),
      /* @__PURE__ */ jsxs("div", { className: "flex flex-col gap-1 p-4", children: [
        data.title ? /* @__PURE__ */ jsx("span", { className: "text-sm font-semibold text-ui-fg-base", children: data.title }) : null,
        data.subtitle ? /* @__PURE__ */ jsx("span", { className: "text-xs font-medium text-ui-fg-subtle", children: data.subtitle }) : null,
        data.body ? /* @__PURE__ */ jsx("span", { className: "line-clamp-2 text-xs text-ui-fg-muted", children: data.body }) : null,
        data.ctaUrl ? /* @__PURE__ */ jsx("div", { className: "mt-1.5", children: /* @__PURE__ */ jsx("span", { className: "inline-flex items-center rounded-md bg-zinc-900 px-2.5 py-1 text-xs font-medium text-white", children: data.ctaLabel || data.ctaUrl }) }) : null
      ] })
    ]
  }
);
  ...
  if (isImageBg) {
    return /* @__PURE__ */ jsxs(
      "div",
      {
        ...
        children: [
          data.mediaUrl ? /* @__PURE__ */ jsx(
            "img",
            {
              src: data.mediaUrl,
              className: "absolute inset-0 h-full w-full object-cover"
            }
          ) : /* @__PURE__ */ jsx("div", { className: "absolute inset-0 flex items-center justify-center bg-white/10 text-xs text-white/70", children: "imagen de fondo" }),
          /* @__PURE__ */ jsxs("div", { className: "relative z-10 flex flex-col items-center gap-2", children: [
            data.showLogo ? /* @__PURE__ */ jsx("span", { className: "flex h-7 items-center rounded-lg bg-white px-2 font-semibold text-[10px] text-zinc-700 shadow", children: "logo" }) : null,
  ...
  return /* @__PURE__ */ jsxs(
    "div",
    {
      ...
      children: [
        ...
        data.subtitle ? /* @__PURE__ */ jsx("span", { className: "text-center text-xs opacity-80", style: { color: fg }, children: data.subtitle }) : null
      ]
    }
  );
};
const StickyPreview = ({ data }) => {
  ...
  return /* @__PURE__ */ jsxs(
    "div",
    {
      ...
      children: [
        (data.title || data.subtitle) && /* @__PURE__ */ jsxs("div", { className: "hidden shrink-0 flex-col sm:flex", style: { color: fg }, children: [
          data.title ? /* @__PURE__ */ jsx("span", { className: "font-semibold text-sm", children: data.title }) : null,
          data.subtitle ? /* @__PURE__ */ jsx("span", { className: "text-xs opacity-80", children: data.subtitle }) : null
        ] }),
        cells.length > 0 ? /* @__PURE__ */ jsx("div", { className: "flex flex-1 items-center gap-2 overflow-hidden", children: cells.map((l, i) => /* @__PURE__ */ jsx(
          "div",
          {
            className: "flex h-[34px] min-w-[60px] items-center justify-center rounded-md bg-white px-2",
            children: l.image ? /* @__PURE__ */ jsx("img", { src: l.image, className: "h-full w-full object-contain py-1" }) : /* @__PURE__ */ jsx("span", { className: "text-[10px] text-zinc-400", children: "logo" })
          },
          i
...
const BannerPreview = ({
  ...
  switch (kind) {
    case "topbar":
      return /* @__PURE__ */ jsx(TopBarPreview, { data });
    case "hero":
      return /* @__PURE__ */ jsx(HeroPreview, { data });
    case "splash":
      return /* @__PURE__ */ jsx(SplashPreview, { data });
    case "sticky":
      return /* @__PURE__ */ jsx(StickyPreview, { data });
    default:
      return /* @__PURE__ */ jsx(CardPreview, { data });
  }
};
const ALL_FIELDS = [
  "internal_name",
...
function BannerFormDrawer({ open, onClose, placement, banner, initialForm }) {
  ...
  async function handleMediaUpload(file) {
    ...
    try {
      ...
      toast.error(t("MEDIA_UPLOAD_FAILED", { msg: (error == null ? void 0 : error.message) ?? "" }));
    } finally {
  ...
  const renderColorField = (field, labelKey, placeholderKey) => {
    ...
    return /* @__PURE__ */ jsxs("div", { className: "flex flex-col gap-2", children: [
      /* @__PURE__ */ jsx(Label, { size: "xsmall", children: t(labelKey) }),
      /* @__PURE__ */ jsx("div", { className: "flex flex-wrap gap-2", children: THEME_COLORS.map((color) => /* @__PURE__ */ jsx(
        "button",
        {
          type: "button",
    ...
    switch (field) {
      case "internal_name":
        return /* @__PURE__ */ jsxs("div", { className: "flex flex-col gap-1", children: [
          /* @__PURE__ */ jsx(Label, { size: "xsmall", children: t("FIELD_INTERNAL_NAME") }),
          /* @__PURE__ */ jsx(
            Input,
            {
          ...
          nameError ? /* @__PURE__ */ jsx(Text, { size: "xsmall", className: "text-ui-fg-error", children: nameError }) : null
        ] }, field);
      case "status":
        return /* @__PURE__ */ jsxs("div", { className: "flex flex-col gap-1", children: [
      ...
      case "device_type":
        return /* @__PURE__ */ jsxs("div", { className: "flex flex-col gap-1", children: [
          /* @__PURE__ */ jsx(Label, { size: "xsmall", children: t("FIELD_DEVICE") }),
          /* @__PURE__ */ jsxs(Select, { value: form.device_type, onValueChange: (v) => set("device_type", v), children: [
            /* @__PURE__ */ jsx(Select.Trigger, { children: /* @__PURE__ */ jsx(Select.Value, { placeholder: t("PLACEHOLDER_DEVICE") }) }),
            /* @__PURE__ */ jsx(Select.Content, { children: DEVICE_TYPES.map((d) => /* @__PURE__ */ jsx(Select.Item, { value: d, children: t(`DEVICE_${d.toUpperCase()}`) }, d)) })
          ] })
        ] }, field);
      case "type":
        return /* @__PURE__ */ jsxs("div", { className: "flex flex-col gap-1", children: [
          /* @__PURE__ */ jsx(Label, { size: "xsmall", children: t("FIELD_TYPE") }),
          /* @__PURE__ */ jsx(
            Input,
            {
              value: form.type,
      ...
      case "priority":
        return /* @__PURE__ */ jsxs("div", { className: "flex flex-col gap-1", children: [
          /* @__PURE__ */ jsx(Label, { size: "xsmall", children: t("FIELD_PRIORITY") }),
          /* @__PURE__ */ jsx(
            Input,
            {
              type: "number",
      ...
      case "splash_bg":
        return /* @__PURE__ */ jsxs("div", { className: "flex flex-col gap-2", children: [
          /* @__PURE__ */ jsx(Label, { size: "xsmall", children: t("FIELD_SPLASH_BG") }),
          /* @__PURE__ */ jsx(Text, { size: "xsmall", className: "text-ui-fg-subtle", children: t("HELP_SPLASH_BG") }),
          /* @__PURE__ */ jsx("div", { className: "flex gap-2", children: ["color", "image"].map((mode) => /* @__PURE__ */ jsxs(
            "button",
            {
              type: "button",
              ...
              children: [
                /* @__PURE__ */ jsx("span", { className: "block font-medium text-ui-fg-base", children: t(mode === "color" ? "SPLASH_BG_COLOR" : "SPLASH_BG_IMAGE") }),
                /* @__PURE__ */ jsx("span", { className: "block text-ui-fg-subtle txt-compact-xsmall", children: t(
      ...
      case "show_logo":
        return /* @__PURE__ */ jsxs("div", { className: "flex items-center justify-between gap-3", children: [
          /* @__PURE__ */ jsxs("div", { className: "flex flex-col", children: [
            /* @__PURE__ */ jsx(Label, { size: "xsmall", children: t("FIELD_SHOW_LOGO") }),
            /* @__PURE__ */ jsx(Text, { size: "xsmall", className: "text-ui-fg-subtle", children: t("HELP_SHOW_LOGO") })
          ] }),
          /* @__PURE__ */ jsx(
            Switch,
            {
      ...
      case "sticky_links":
        return /* @__PURE__ */ jsxs("div", { className: "flex flex-col gap-2", children: [
          /* @__PURE__ */ jsx(Label, { size: "xsmall", children: t("FIELD_STICKY_LINKS") }),
          /* @__PURE__ */ jsx(Text, { size: "xsmall", className: "text-ui-fg-subtle", children: t("HELP_STICKY_LINKS") }),
          form.sticky_links.map((row, i) => /* @__PURE__ */ jsxs(
            "div",
            {
              className: "flex flex-wrap items-end gap-2 rounded-lg border border-ui-border-base p-2",
              children: [
                /* @__PURE__ */ jsxs("div", { className: "flex min-w-[160px] flex-1 flex-col gap-1", children: [
                  /* @__PURE__ */ jsx(Label, { size: "xsmall", children: t("FIELD_STICKY_LINK_IMAGE") }),
                  /* @__PURE__ */ jsx(
                    Input,
                    {
                      value: row.image,
                ...
                /* @__PURE__ */ jsxs("div", { className: "flex min-w-[160px] flex-1 flex-col gap-1", children: [
                  /* @__PURE__ */ jsx(Label, { size: "xsmall", children: t("FIELD_STICKY_LINK_URL") }),
                  /* @__PURE__ */ jsx(
                    Input,
                    {
                      value: row.url,
      ...
      case "countdown_seconds":
        return /* @__PURE__ */ jsxs("div", { className: "flex flex-col gap-1", children: [
          /* @__PURE__ */ jsx(Label, { size: "xsmall", children: t("FIELD_COUNTDOWN_SECONDS") }),
          /* @__PURE__ */ jsx(
            Input,
            {
              type: "number",
          ...
          /* @__PURE__ */ jsx(Text, { size: "xsmall", className: "text-ui-fg-subtle", children: t("HELP_COUNTDOWN_SECONDS") })
        ] }, field);
      case "content_title":
        return /* @__PURE__ */ jsxs("div", { className: "flex flex-col gap-1", children: [
          /* @__PURE__ */ jsx(Label, { size: "xsmall", children: t("FIELD_CONTENT_TITLE") }),
          /* @__PURE__ */ jsx(
            Input,
            {
      ...
      case "content_subtitle":
        return /* @__PURE__ */ jsxs("div", { className: "flex flex-col gap-1", children: [
          /* @__PURE__ */ jsx(Label, { size: "xsmall", children: t("FIELD_CONTENT_SUBTITLE") }),
          /* @__PURE__ */ jsx(
            Input,
            {
      ...
      case "content_body":
        return /* @__PURE__ */ jsxs("div", { className: "flex flex-col gap-1", children: [
          /* @__PURE__ */ jsx(Label, { size: "xsmall", children: t("FIELD_CONTENT_BODY") }),
          /* @__PURE__ */ jsx(
            Textarea,
            {
      ...
      case "media_url":
        return /* @__PURE__ */ jsxs("div", { className: "flex flex-col gap-1", children: [
          /* @__PURE__ */ jsx(Label, { size: "xsmall", children: t("FIELD_MEDIA_URL") }),
          /* @__PURE__ */ jsx(
            Input,
            {
          ...
          /* @__PURE__ */ jsxs("div", { className: "mt-1 flex items-center gap-2", children: [
            ...
            /* @__PURE__ */ jsx(Text, { size: "xsmall", className: "text-ui-fg-subtle", children: t("MEDIA_UPLOAD_HINT") })
          ] })
        ] }, field);
      case "cta_url":
        return /* @__PURE__ */ jsxs("div", { className: "flex flex-col gap-1", children: [
          /* @__PURE__ */ jsx(Label, { size: "xsmall", children: t("FIELD_CTA_URL") }),
          /* @__PURE__ */ jsx(
            Input,
            {
              value: form.cta_url,
      ...
      case "cta_label":
        return /* @__PURE__ */ jsxs("div", { className: "flex flex-col gap-1", children: [
          /* @__PURE__ */ jsx(Label, { size: "xsmall", children: t("FIELD_CTA_LABEL") }),
          /* @__PURE__ */ jsx(
            Input,
            {
      ...
      case "cta_target":
        return /* @__PURE__ */ jsxs("div", { className: "flex flex-col gap-1", children: [
          /* @__PURE__ */ jsx(Label, { size: "xsmall", children: t("FIELD_CTA_TARGET") }),
          /* @__PURE__ */ jsxs(Select, { value: form.cta_target, onValueChange: (v) => set("cta_target", v), children: [
            /* @__PURE__ */ jsx(Select.Trigger, { children: /* @__PURE__ */ jsx(Select.Value, {}) }),
            /* @__PURE__ */ jsxs(Select.Content, { children: [
              /* @__PURE__ */ jsx(Select.Item, { value: "_self", children: t("TARGET_SELF") }),
              /* @__PURE__ */ jsx(Select.Item, { value: "_blank", children: t("TARGET_BLANK") })
            ] })
          ] })
        ] }, field);
      case "icon":
        return /* @__PURE__ */ jsxs("div", { className: "flex flex-col gap-1", children: [
          /* @__PURE__ */ jsx(Label, { size: "xsmall", children: t("FIELD_ICON") }),
          /* @__PURE__ */ jsxs(Select, { value: form.icon, onValueChange: (v) => set("icon", v), children: [
            /* @__PURE__ */ jsx(Select.Trigger, { children: /* @__PURE__ */ jsx(Select.Value, { placeholder: t("PLACEHOLDER_ICON") }) }),
            /* @__PURE__ */ jsx(Select.Content, { children: TOPBAR_ICONS.map((icon) => /* @__PURE__ */ jsx(Select.Item, { value: icon, children: t(`ICON_${icon.replace(/-/g, "_").toUpperCase()}`, {
      ...
      case "start_at":
        return /* @__PURE__ */ jsxs("div", { className: "flex flex-col gap-1", children: [
          /* @__PURE__ */ jsx(Label, { size: "xsmall", children: t("FIELD_START_AT") }),
          /* @__PURE__ */ jsx(
            DatePicker,
            {
              granularity: "minute",
      ...
      case "end_at":
        return /* @__PURE__ */ jsxs("div", { className: "flex flex-col gap-1", children: [
          /* @__PURE__ */ jsx(Label, { size: "xsmall", children: t("FIELD_END_AT") }),
          /* @__PURE__ */ jsx(
            DatePicker,
            {
              granularity: "minute",
      ...
      case "customer_group_ids":
        return /* @__PURE__ */ jsxs("div", { className: "flex flex-col gap-2", children: [
          /* @__PURE__ */ jsx(Label, { size: "xsmall", children: t("FIELD_CUSTOMER_GROUPS") }),
          /* @__PURE__ */ jsx(Text, { size: "xsmall", className: "text-ui-fg-subtle", children: form.customer_group_ids.length === 0 ? t("TARGETING_ALL_HINT") : t("TARGETING_SELECTED_HINT") }),
          customerGroups.length === 0 ? /* @__PURE__ */ jsx(Text, { size: "small", className: "text-ui-fg-muted", children: t("TARGETING_NO_GROUPS") }) : /* @__PURE__ */ jsx("div", { className: "flex flex-col gap-2 rounded-lg border border-ui-border-base p-3", children: customerGroups.map((group) => /* @__PURE__ */ jsxs(
            "label",
            {
              ...
              children: [
                ...
                /* @__PURE__ */ jsx(Text, { size: "small", children: group.name ?? group.id })
              ]
            },
            group.id
          )) })
  ...
  return /* @__PURE__ */ jsx(FocusModal, { open, onOpenChange: (v) => !v && onClose(), children: /* @__PURE__ */ jsx(FocusModal.Content, { children: /* @__PURE__ */ jsxs(
    ProgressTabs,
    {
      value: activeTab,
      ...
      children: [
        /* @__PURE__ */ jsxs(FocusModal.Header, { className: "flex items-center gap-4", children: [
          /* @__PURE__ */ jsx(FocusModal.Title, { asChild: true, children: /* @__PURE__ */ jsx("span", { className: "sr-only", children: isEditing ? t("FORM_EDIT_ITEM_TITLE", { item: t(config2.itemLabelKey) }) : t("FORM_CREATE_ITEM_TITLE", { item: t(config2.itemLabelKey) }) }) }),
          /* @__PURE__ */ jsx("div", { className: "-my-2 w-full border-l", children: /* @__PURE__ */ jsx(ProgressTabs.List, { children: tabs.map((tab, index) => /* @__PURE__ */ jsx(
        ...
        /* @__PURE__ */ jsx(FocusModal.Body, { className: "flex flex-1 overflow-hidden", children: /* @__PURE__ */ jsxs("form", { id: "banner-form", onSubmit: handleSubmit, className: "flex w-full", children: [
          /* @__PURE__ */ jsx("div", { className: "flex-1 overflow-y-auto px-8 py-12", children: /* @__PURE__ */ jsx("div", { className: "mx-auto flex w-full max-w-[640px] flex-col", children: tabs.map((tab) => /* @__PURE__ */ jsxs(
            ProgressTabs.Content,
            {
              ...
              children: [
                /* @__PURE__ */ jsxs("div", { className: "flex items-center gap-2", children: [
                  /* @__PURE__ */ jsx(Heading, { children: t(tab.labelKey) }),
                  /* @__PURE__ */ jsx(Badge, { size: "2xsmall", children: t(config2.labelKey) })
                ] }),
                tab.groups.map((group) => /* @__PURE__ */ jsxs("div", { className: "flex flex-col gap-4", children: [
                  tab.groups.length > 1 ? /* @__PURE__ */ jsx(Text, { size: "small", weight: "plus", className: "text-ui-fg-base", children: t(group.titleKey) }) : null,
                  group.fields.map(renderField)
                ] }, group.titleKey)),
                tab.id === "targeting" ? /* @__PURE__ */ jsx(
          ...
          /* @__PURE__ */ jsx("aside", { className: "hidden w-[400px] shrink-0 overflow-y-auto border-l border-ui-border-base bg-ui-bg-subtle px-6 py-6 lg:block", children: /* @__PURE__ */ jsxs("div", { className: "flex flex-col gap-2", children: [
            /* @__PURE__ */ jsx(Label, { className: "font-semibold text-ui-fg-base", children: t("PREVIEW_TITLE") }),
            /* @__PURE__ */ jsx(
              BannerPreview,
              {
            ...
            /* @__PURE__ */ jsx(Text, { size: "xsmall", className: "text-ui-fg-muted", children: t("PREVIEW_HINT") })
          ] }) })
        ] }) }),
        /* @__PURE__ */ jsx(FocusModal.Footer, { children: /* @__PURE__ */ jsxs("div", { className: "flex items-center justify-end gap-x-2", children: [
          /* @__PURE__ */ jsx(Button, { variant: "secondary", size: "small", onClick: onClose, disabled: isPending, children: t("BTN_CANCEL") }),
          isEditing || isLastTab ? /* @__PURE__ */ jsx(Button, { type: "submit", size: "small", form: "banner-form", isLoading: isPending, children: isEditing ? t("BTN_SAVE") : t("CREATE_BUTTON") }) : /* @__PURE__ */ jsx(
            Button,
            {
              type: "button",
              size: "small",
...
function AiComposeDrawer({ open, onClose, onComposed }) {
  ...
  return /* @__PURE__ */ jsx(Drawer, { open, onOpenChange: (v) => !v && close(), children: /* @__PURE__ */ jsxs(Drawer.Content, { children: [
    /* @__PURE__ */ jsx(Drawer.Header, { children: /* @__PURE__ */ jsx(Heading, { children: t("AI_COMPOSE_TITLE") }) }),
    /* @__PURE__ */ jsxs(Drawer.Body, { className: "flex flex-col gap-4 overflow-y-auto p-4", children: [
      /* @__PURE__ */ jsx(Text, { size: "small", className: "text-ui-fg-subtle", children: t("AI_COMPOSE_SUBTITLE") }),
      /* @__PURE__ */ jsxs("div", { className: "flex flex-col gap-1", children: [
        /* @__PURE__ */ jsx(Label, { size: "xsmall", children: t("AI_COMPOSE_PLACEMENT") }),
        /* @__PURE__ */ jsxs(Select, { value: placement, onValueChange: setPlacement, children: [
          /* @__PURE__ */ jsx(Select.Trigger, { children: /* @__PURE__ */ jsx(Select.Value, {}) }),
          /* @__PURE__ */ jsx(Select.Content, { className: "z-[60]", children: PLACEMENT_IDS.map((id) => /* @__PURE__ */ jsx(Select.Item, { value: id, children: t(PLACEMENT_CONFIG[id].labelKey) }, id)) })
        ] })
      ] }),
      /* @__PURE__ */ jsxs("div", { className: "flex flex-col gap-1", children: [
        /* @__PURE__ */ jsx(Label, { size: "xsmall", children: t("AI_BRIEF_LABEL") }),
        /* @__PURE__ */ jsx(
          Textarea,
          {
            rows: 3,
      ...
      /* @__PURE__ */ jsxs("div", { className: "grid grid-cols-1 gap-2 sm:grid-cols-3", children: [
        /* @__PURE__ */ jsx(Input, { placeholder: t("AI_GOAL"), value: goal, onChange: (e) => setGoal(e.target.value) }),
        /* @__PURE__ */ jsx(Input, { placeholder: t("AI_TONE"), value: tone, onChange: (e) => setTone(e.target.value) }),
        /* @__PURE__ */ jsx(
          Input,
          {
      ...
      /* @__PURE__ */ jsxs("div", { className: "flex flex-col gap-2", children: [
        /* @__PURE__ */ jsx(Label, { size: "xsmall", children: t("AI_COMPOSE_PRODUCTS_LABEL") }),
        /* @__PURE__ */ jsx(ProductSelector, { value: productIds, onChange: setProductIds }),
        /* @__PURE__ */ jsx(Text, { size: "xsmall", className: "text-ui-fg-muted", children: t("AI_COMPOSE_PRODUCTS_HELP") })
      ] }),
      result ? /* @__PURE__ */ jsxs("div", { className: "flex flex-col gap-2 border-t border-ui-border-base pt-4", children: [
        /* @__PURE__ */ jsx(Label, { size: "xsmall", children: t("AI_COMPOSE_PREVIEW") }),
        /* @__PURE__ */ jsx(
          BannerPreview,
          {
        ...
        /* @__PURE__ */ jsx(Text, { size: "xsmall", className: "text-ui-fg-muted", children: t("AI_COMPOSE_PREVIEW_HELP") })
      ] }) : null
    ] }),
    /* @__PURE__ */ jsxs(Drawer.Footer, { children: [
      /* @__PURE__ */ jsx(Button, { variant: "secondary", size: "small", onClick: close, disabled: compose.isPending, children: t("BTN_CANCEL") }),
      result ? /* @__PURE__ */ jsxs(Fragment, { children: [
        ...
        /* @__PURE__ */ jsx(Button, { size: "small", onClick: handleUse, disabled: compose.isPending, children: t("AI_COMPOSE_USE") })
      ] }) : /* @__PURE__ */ jsx(
        Button,
        {
          size: "small",
...
const TopBarShapes = () => /* @__PURE__ */ jsxs(Fragment, { children: [
  /* @__PURE__ */ jsx("rect", { x: 16, y: 56, width: 288, height: 108, rx: 10, fill: "currentColor", fillOpacity: 0.05 }),
  /* @__PURE__ */ jsx("rect", { x: 16, y: 16, width: 288, height: 28, rx: 8, fill: "currentColor", fillOpacity: 0.16 }),
  /* @__PURE__ */ jsx("circle", { cx: 126, cy: 30, r: 5, fill: "currentColor", fillOpacity: 0.7 }),
  /* @__PURE__ */ jsx("rect", { x: 140, y: 27, width: 54, height: 6, rx: 3, fill: "currentColor", fillOpacity: 0.45 })
] });
const HeroShapes = () => /* @__PURE__ */ jsxs(Fragment, { children: [
  /* @__PURE__ */ jsx("rect", { x: 16, y: 16, width: 288, height: 148, rx: 12, fill: "currentColor", fillOpacity: 0.09 }),
  /* @__PURE__ */ jsx("rect", { x: 40, y: 58, width: 54, height: 6, rx: 3, fill: "currentColor", fillOpacity: 0.35 }),
  /* @__PURE__ */ jsx("rect", { x: 40, y: 74, width: 150, height: 13, rx: 4, fill: "currentColor", fillOpacity: 0.8 }),
  /* @__PURE__ */ jsx("rect", { x: 40, y: 93, width: 112, height: 13, rx: 4, fill: "currentColor", fillOpacity: 0.8 }),
  /* @__PURE__ */ jsx("rect", { x: 40, y: 114, width: 132, height: 6, rx: 3, fill: "currentColor", fillOpacity: 0.28 }),
  /* @__PURE__ */ jsx("rect", { x: 40, y: 130, width: 66, height: 18, rx: 9, fill: "currentColor", fillOpacity: 0.85 })
] });
const CardShapes = () => /* @__PURE__ */ jsxs(Fragment, { children: [
  /* @__PURE__ */ jsx("rect", { x: 76, y: 18, width: 168, height: 144, rx: 12, fill: "currentColor", fillOpacity: 0.09 }),
  /* @__PURE__ */ jsx("rect", { x: 90, y: 30, width: 140, height: 52, rx: 7, fill: "currentColor", fillOpacity: 0.16 }),
  /* @__PURE__ */ jsx("rect", { x: 90, y: 94, width: 104, height: 9, rx: 4, fill: "currentColor", fillOpacity: 0.8 }),
  /* @__PURE__ */ jsx("rect", { x: 90, y: 109, width: 140, height: 5, rx: 2.5, fill: "currentColor", fillOpacity: 0.28 }),
  /* @__PURE__ */ jsx("rect", { x: 90, y: 120, width: 116, height: 5, rx: 2.5, fill: "currentColor", fillOpacity: 0.28 }),
  /* @__PURE__ */ jsx("rect", { x: 90, y: 134, width: 56, height: 14, rx: 7, fill: "currentColor", fillOpacity: 0.85 })
] });
const SplashShapes = () => /* @__PURE__ */ jsxs(Fragment, { children: [
  /* @__PURE__ */ jsx(
    "rect",
    {
      x: 118,
  ...
  /* @__PURE__ */ jsx("rect", { x: 150, y: 26, width: 20, height: 8, rx: 4, fill: "currentColor", fillOpacity: 0.55 }),
  /* @__PURE__ */ jsx("rect", { x: 134, y: 42, width: 52, height: 8, rx: 4, fill: "currentColor", fillOpacity: 0.8 }),
  /* @__PURE__ */ jsx("rect", { x: 142, y: 54, width: 36, height: 8, rx: 4, fill: "currentColor", fillOpacity: 0.8 }),
  /* @__PURE__ */ jsx("rect", { x: 134, y: 72, width: 52, height: 48, rx: 8, fill: "currentColor", fillOpacity: 0.16 }),
  /* @__PURE__ */ jsx("rect", { x: 138, y: 132, width: 44, height: 5, rx: 2.5, fill: "currentColor", fillOpacity: 0.28 })
] });
const StickyShapes = () => /* @__PURE__ */ jsxs(Fragment, { children: [
  /* @__PURE__ */ jsx("rect", { x: 16, y: 14, width: 288, height: 98, rx: 10, fill: "currentColor", fillOpacity: 0.05 }),
  /* @__PURE__ */ jsx("rect", { x: 24, y: 122, width: 272, height: 42, rx: 14, fill: "currentColor", fillOpacity: 0.15 }),
  /* @__PURE__ */ jsx("rect", { x: 40, y: 134, width: 40, height: 18, rx: 4, fill: "currentColor", fillOpacity: 0.6 }),
  /* @__PURE__ */ jsx("rect", { x: 88, y: 134, width: 40, height: 18, rx: 4, fill: "currentColor", fillOpacity: 0.6 }),
  /* @__PURE__ */ jsx("rect", { x: 136, y: 134, width: 40, height: 18, rx: 4, fill: "currentColor", fillOpacity: 0.6 }),
  /* @__PURE__ */ jsx("rect", { x: 226, y: 136, width: 54, height: 14, rx: 7, fill: "currentColor", fillOpacity: 0.85 })
] });
const SHAPES = {
  topbar: TopBarShapes,
  hero: HeroShapes,
...
const PlacementThumbnail = ({ kind }) => {
  ...
  return /* @__PURE__ */ jsx("div", { className: "flex aspect-[16/9] w-full items-center justify-center overflow-hidden rounded-lg border border-ui-border-base bg-ui-bg-subtle text-ui-fg-base", children: /* @__PURE__ */ jsx("svg", { viewBox: VIEWBOX, className: "h-full w-full", role: "img", "aria-hidden": "true", children: /* @__PURE__ */ jsx(Shapes, {}) }) });
};
const BannersPage = () => {
  const { t, i18n } = useTranslation("banners");
  registerBannersTranslations(i18n);
  ...
  return /* @__PURE__ */ jsxs(Fragment, { children: [
    /* @__PURE__ */ jsx(SiteScopeBar, { screen: "banners" }),
    /* @__PURE__ */ jsxs(Container, { className: "divide-y p-0", children: [
      /* @__PURE__ */ jsxs("div", { className: "flex flex-wrap items-center justify-between gap-2 px-6 py-4", children: [
        /* @__PURE__ */ jsxs("div", { className: "flex items-center gap-x-2", children: [
          ...
          /* @__PURE__ */ jsx(ExtensionVersion, { extension: "banners" })
        ] }),
        /* @__PURE__ */ jsxs("div", { className: "flex items-center gap-2", children: [
          /* @__PURE__ */ jsxs(Select, { value: newPlacement, onValueChange: setNewPlacement, size: "small", children: [
            /* @__PURE__ */ jsx(Select.Trigger, { className: "w-48", children: /* @__PURE__ */ jsx(Select.Value, {}) }),
            /* @__PURE__ */ jsx(Select.Content, { children: PLACEMENT_IDS.map((placementId) => {
              const config2 = PLACEMENT_CONFIG[placementId];
              return /* @__PURE__ */ jsx(Select.Item, { value: placementId, children: t(config2.labelKey) }, placementId);
            }) })
          ] }),
          /* @__PURE__ */ jsx(Button, { size: "small", variant: "secondary", onClick: openManualCreate, children: t("CREATE_BUTTON") }),
          /* @__PURE__ */ jsxs(Button, { size: "small", onClick: () => setAiOpen(true), children: [
            "✨ ",
            t("AI_COMPOSE_BUTTON")
          ] })
        ] })
      ] }),
      /* @__PURE__ */ jsx("div", { className: "grid grid-cols-1 gap-4 px-6 py-6 sm:grid-cols-2 xl:grid-cols-3", children: rows.map((row) => /* @__PURE__ */ jsxs(
        "button",
        {
          type: "button",
          ...
          children: [
            /* @__PURE__ */ jsx(PlacementThumbnail, { kind: row.preview }),
            /* @__PURE__ */ jsxs("div", { className: "flex items-start justify-between gap-2 px-1", children: [
              /* @__PURE__ */ jsxs("div", { className: "min-w-0", children: [
                /* @__PURE__ */ jsx(Text, { size: "small", weight: "plus", className: "truncate text-ui-fg-base", children: row.label }),
                /* @__PURE__ */ jsx(Text, { size: "small", className: "truncate text-ui-fg-subtle", children: row.itemsLabel })
              ] }),
              isLoading ? null : /* @__PURE__ */ jsx(StatusBadge, { color: row.live > 0 ? "green" : "grey", className: "shrink-0", children: row.live > 0 ? t("STATUS_LIVE") : t("STATUS_INACTIVE") })
            ] }),
            /* @__PURE__ */ jsx("div", { className: "flex min-h-[24px] flex-wrap items-center gap-1.5 px-1", children: isLoading ? /* @__PURE__ */ jsx("div", { className: "h-5 w-28 animate-pulse rounded-full bg-ui-bg-component" }) : /* @__PURE__ */ jsxs(Fragment, { children: [
              row.live > 0 ? /* @__PURE__ */ jsxs(Badge, { size: "2xsmall", color: "green", children: [
                t("COL_ACTIVE"),
                ": ",
                row.live
              ] }) : null,
              row.drafts > 0 ? /* @__PURE__ */ jsxs(Badge, { size: "2xsmall", color: "orange", children: [
                t("COL_DRAFTS"),
                ": ",
                row.drafts
              ] }) : null,
              row.next ? /* @__PURE__ */ jsx(Badge, { size: "2xsmall", color: "blue", children: t("BADGE_NEXT", { date: formatDate(row.next) }) }) : null,
              row.live === 0 && row.drafts === 0 && !row.next ? /* @__PURE__ */ jsx(Text, { size: "small", className: "text-ui-fg-muted", children: "—" }) : null
            ] }) })
          ]
        },
        row.id
...
const BannersIcon = () => /* @__PURE__ */ jsx(Newspaper, { style: { color: "#4B8EEF" } });
...
const CredentialsPage = () => /* @__PURE__ */ jsx(Navigate, { to: "/settings/site-credentials#banners", replace: true });
...
const ActionsCell = ({ banner, onEdit }) => {
  ...
  return /* @__PURE__ */ jsx("div", { onClick: (e) => e.stopPropagation(), children: /* @__PURE__ */ jsxs(DropdownMenu, { children: [
    ...
    /* @__PURE__ */ jsxs(DropdownMenu.Content, { align: "end", children: [
      /* @__PURE__ */ jsxs(DropdownMenu.Item, { className: "gap-x-2", onClick: () => onEdit(banner), children: [
        /* @__PURE__ */ jsx(PencilSquare, { className: "text-ui-fg-subtle" }),
        t("ACTION_EDIT")
      ] }),
      /* @__PURE__ */ jsxs(DropdownMenu.Item, { className: "gap-x-2", onClick: handleDuplicate, children: [
        /* @__PURE__ */ jsx(SquareTwoStack, { className: "text-ui-fg-subtle" }),
        t("ACTION_DUPLICATE")
      ] }),
      banner.status !== "published" && /* @__PURE__ */ jsxs(
        DropdownMenu.Item,
        {
          className: "gap-x-2",
      ...
      banner.status === "published" && /* @__PURE__ */ jsxs(
        DropdownMenu.Item,
        {
          ...
          children: [
            /* @__PURE__ */ jsx(EllipsisHorizontal, { className: "text-ui-fg-subtle" }),
            t("ACTION_UNPUBLISH")
          ]
        }
      ),
      banner.status !== "archived" && /* @__PURE__ */ jsxs(
        DropdownMenu.Item,
        {
          className: "gap-x-2",
          onClick: () => run(() => archiveBanner(banner.id), "TOAST_ARCHIVED", "TOAST_ARCHIVE_FAILED"),
          children: [
            /* @__PURE__ */ jsx(ArchiveBox, { className: "text-ui-fg-subtle" }),
            t("ACTION_ARCHIVE")
          ]
        }
      ),
      /* @__PURE__ */ jsx(DropdownMenu.Separator, {}),
      /* @__PURE__ */ jsxs(DropdownMenu.Item, { className: "gap-x-2", onClick: handleDelete, children: [
...
function PlacementItemsTable({ titleKey, items, onEdit }) {
      ...
      columnHelper.accessor("internal_name", {
        ...
        cell: ({ row }) => {
          ...
          return /* @__PURE__ */ jsxs("div", { className: "flex min-w-0 flex-col gap-0.5", children: [
            /* @__PURE__ */ jsx(Text, { size: "small", weight: "plus", className: "truncate", children: banner.internal_name || "—" }),
            snippet ? /* @__PURE__ */ jsx(Text, { size: "xsmall", className: "truncate text-ui-fg-subtle", children: snippet }) : null
          ] });
        }
      }),
      columnHelper.accessor("device_type", {
        header: t("COL_DEVICE"),
        cell: ({ getValue }) => /* @__PURE__ */ jsx(Badge, { size: "2xsmall", children: t(`DEVICE_${(getValue() || "all").toUpperCase()}`) })
      }),
      columnHelper.accessor("priority", {
        header: t("COL_PRIORITY"),
        cell: ({ row }) => /* @__PURE__ */ jsx(PriorityCell, { banner: row.original })
      }),
      columnHelper.accessor("status", {
        header: t("COL_STATUS"),
        cell: ({ row }) => /* @__PURE__ */ jsxs("div", { className: "flex items-center gap-1.5", children: [
          /* @__PURE__ */ jsx(StatusBadge, { color: statusColor(row.original.status), children: t(`STATUS_${row.original.status.toUpperCase()}`) }),
          isScheduled(row.original) ? /* @__PURE__ */ jsx(Badge, { size: "2xsmall", color: "blue", children: t("GROUP_SCHEDULED") }) : null
        ] })
      }),
      columnHelper.display({
        id: "actions",
        header: "",
        cell: ({ row }) => /* @__PURE__ */ jsx(ActionsCell, { banner: row.original, onEdit })
      })
    ],
    [t, onEdit]
  );
  ...
  return /* @__PURE__ */ jsx(Container, { className: "p-0", children: /* @__PURE__ */ jsxs(DataTable, { instance: table, children: [
    /* @__PURE__ */ jsx(DataTable.Toolbar, { className: "flex items-center justify-between px-6 py-4", children: /* @__PURE__ */ jsxs(Heading, { level: "h2", children: [
      t(titleKey),
      " (",
      items.length,
      ")"
...
const PlacementEditorPage = () => {
  ...
  if (!isKnown) {
    return /* @__PURE__ */ jsxs(Container, { className: "flex flex-col gap-4 p-6", children: [
      /* @__PURE__ */ jsx(Text, { className: "text-ui-fg-subtle", children: t("PLACEMENT_UNKNOWN") }),
      /* @__PURE__ */ jsx("div", { children: /* @__PURE__ */ jsx(Button, { variant: "secondary", size: "small", onClick: () => navigate("/banners"), children: t("BACK_TO_PLACEMENTS") }) })
    ] });
  }
  return /* @__PURE__ */ jsxs(Fragment, { children: [
    /* @__PURE__ */ jsxs("div", { className: "flex flex-col gap-y-4", children: [
      /* @__PURE__ */ jsxs(Container, { className: "flex items-center justify-between p-6", children: [
        /* @__PURE__ */ jsxs("div", { className: "flex items-center gap-3", children: [
          /* @__PURE__ */ jsx(IconButton, { size: "small", variant: "transparent", onClick: () => navigate("/banners"), children: /* @__PURE__ */ jsx(ArrowLeft, {}) }),
          /* @__PURE__ */ jsx(Heading, { children: t(config2.labelKey) })
        ] }),
        /* @__PURE__ */ jsxs("div", { className: "flex items-center gap-2", children: [
          /* @__PURE__ */ jsxs(Select, { value: deviceFilter, onValueChange: setDeviceFilter, size: "small", children: [
            /* @__PURE__ */ jsx(Select.Trigger, { className: "w-56 whitespace-nowrap", children: /* @__PURE__ */ jsx(Select.Value, {}) }),
            /* @__PURE__ */ jsx(Select.Content, { children: DEVICE_FILTERS.map((d) => /* @__PURE__ */ jsx(Select.Item, { value: d, children: d === "all" ? t("DEVICE_FILTER_ALL") : t(`DEVICE_${d.toUpperCase()}`) }, d)) })
          ] }),
          /* @__PURE__ */ jsx(Button, { variant: "secondary", size: "small", onClick: openCreate, children: t("ADD_ITEM", { item: t(config2.itemLabelKey).toLowerCase() }) })
        ] })
      ] }),
      /* @__PURE__ */ jsxs(Container, { className: "flex flex-col gap-3 p-6", children: [
        /* @__PURE__ */ jsx(Text, { size: "xsmall", weight: "plus", className: "uppercase text-ui-fg-muted", children: t("PREVIEW_TITLE") }),
        live.length === 0 ? /* @__PURE__ */ jsx("div", { className: "flex items-center justify-center rounded-lg border border-dashed border-ui-border-base py-10", children: /* @__PURE__ */ jsx(Text, { size: "small", className: "text-ui-fg-subtle", children: t("PREVIEW_EMPTY") }) }) : config2.preview === "card" ? /* @__PURE__ */ jsx("div", { className: "grid grid-cols-1 gap-3 md:grid-cols-2 xl:grid-cols-3", children: live.map((banner) => /* @__PURE__ */ jsx(BannerPreview, { kind: "card", data: bannerToPreviewData(banner) }, banner.id)) }) : /* @__PURE__ */ jsx("div", { className: "flex flex-col gap-2", children: live.map((banner) => /* @__PURE__ */ jsx(
          BannerPreview,
          {
            kind: config2.preview,
      ...
      isLoading ? /* @__PURE__ */ jsx(Container, { className: "p-6", children: /* @__PURE__ */ jsx(Text, { size: "small", className: "text-ui-fg-subtle", children: t("LOADING") }) }) : items.length === 0 ? /* @__PURE__ */ jsx(Container, { className: "p-6", children: /* @__PURE__ */ jsxs("div", { className: "flex flex-col items-center gap-3 py-8", children: [
        /* @__PURE__ */ jsx(Text, { className: "text-ui-fg-subtle", children: t("PLACEMENT_EMPTY") }),
        /* @__PURE__ */ jsx(Button, { variant: "secondary", size: "small", onClick: openCreate, children: t("ADD_ITEM", { item: t(config2.itemLabelKey).toLowerCase() }) })
      ] }) }) : /* @__PURE__ */ jsxs(Fragment, { children: [
        /* @__PURE__ */ jsx(PlacementItemsTable, { titleKey: "GROUP_PUBLISHED", items: live, onEdit: openEdit }),
        /* @__PURE__ */ jsx(PlacementItemsTable, { titleKey: "GROUP_SCHEDULED", items: scheduled, onEdit: openEdit }),
        /* @__PURE__ */ jsx(PlacementItemsTable, { titleKey: "GROUP_DRAFTS", items: drafts, onEdit: openEdit }),
        /* @__PURE__ */ jsx(PlacementItemsTable, { titleKey: "GROUP_ARCHIVED", items: archived, onEdit: openEdit })
      ] })
    ] }),
    /* @__PURE__ */ jsx(
      BannerFormDrawer,
