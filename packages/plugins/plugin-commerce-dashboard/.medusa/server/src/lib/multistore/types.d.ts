...
/** Sin módulo, sin tabla o tabla vacía. Proyecto sin multitienda. No se filtra. */
 | {
    status: 'registryAbsent';
    reason: 'module' | 'table' | 'empty';
}
 ...
 * lo correcto.
 */
export declare const shouldFilter: (resolution: SiteResolution) => resolution is {
    status: "site";
    site: SiteRef;
};
/** Code estable para que el admin sepa limpiar su tienda persistida y volver a elegir. */
export declare const UNKNOWN_SITE_ERROR_CODE = "MULTISTORE_UNKNOWN_SITE";
