...
import { ChartBar, Trash, Plus, TriangleDownMini, TriangleRightMini, EllipsisHorizontal, PencilSquare, ArrowPath, EyeMini, CheckCircleSolid, XCircleSolid, ChevronDownMini } from "@medusajs/icons";
import { Navigate } from "react-router-dom";
import { Label, Text, Input, IconButton, Button, usePrompt, Drawer, Heading, Switch, toast, DropdownMenu, Badge, StatusBadge, Tooltip, clx, createDataTableColumnHelper, createDataTableFilterHelper, useDataTable, Container, DataTable, Toaster } from "@medusajs/ui";
import { useState, useEffect, useRef, useMemo } from "react";
import { useTranslation } from "react-i18next";
import { useQuery, useQueryClient, useMutation } from "@tanstack/react-query";
import "@medusajs/admin-shared";
const Ga4Redirect = () => /* @__PURE__ */ jsx(Navigate, { to: "/ga4/events", replace: true });
const Ga4Icon = () => /* @__PURE__ */ jsx(ChartBar, { style: { color: "#7270F5" } });
...
const useTestGa4Config = (options) => useMutation({
...
const ParamMappingsEditor = ({
  ...
  return /* @__PURE__ */ jsxs("div", { className: "flex flex-col gap-3", children: [
    /* @__PURE__ */ jsxs("div", { children: [
      /* @__PURE__ */ jsx(Label, { children: t("PARAMS_TITLE") }),
      /* @__PURE__ */ jsx(Text, { size: "small", className: "text-ui-fg-subtle", children: t("PARAMS_HELP") }),
      suggestedParams && suggestedParams.length > 0 && /* @__PURE__ */ jsx(Text, { size: "small", className: "text-ui-fg-muted", children: t("PARAMS_SUGGESTED", { params: suggestedParams.join(", ") }) }),
      /* @__PURE__ */ jsx("div", { className: "mt-2 rounded-lg bg-ui-bg-subtle px-3 py-2", children: /* @__PURE__ */ jsx(Text, { size: "small", className: "text-ui-fg-muted", children: t("PARAMS_EXAMPLE") }) })
    ] }),
    rows.map((row, index) => /* @__PURE__ */ jsxs("div", { className: "flex items-end gap-2", children: [
      /* @__PURE__ */ jsxs("div", { className: "flex flex-1 flex-col gap-1", children: [
        index === 0 && /* @__PURE__ */ jsx(Label, { size: "small", className: "text-ui-fg-subtle", children: t("PARAM_GA4_PARAM_LABEL") }),
        /* @__PURE__ */ jsx(
          Input,
          {
            size: "small",
      ...
      /* @__PURE__ */ jsxs("div", { className: "flex flex-1 flex-col gap-1", children: [
        index === 0 && /* @__PURE__ */ jsx(Label, { size: "small", className: "text-ui-fg-subtle", children: t("PARAM_SOURCE_PATH_LABEL") }),
        /* @__PURE__ */ jsx(
          Input,
          {
            size: "small",
      ...
      /* @__PURE__ */ jsxs("div", { className: "flex flex-1 flex-col gap-1", children: [
        index === 0 && /* @__PURE__ */ jsx(Label, { size: "small", className: "text-ui-fg-subtle", children: t("PARAM_STATIC_VALUE_LABEL") }),
        /* @__PURE__ */ jsx(
          Input,
          {
            size: "small",
    ...
    /* @__PURE__ */ jsx("div", { children: /* @__PURE__ */ jsxs(Button, { type: "button", variant: "secondary", size: "small", onClick: addRow, children: [
      /* @__PURE__ */ jsx(Plus, {}),
      t("PARAM_ADD")
    ] }) })
  ] });
...
const AdvancedParams = ({ rows, onChange, suggestedParams }) => {
  ...
  return /* @__PURE__ */ jsxs("div", { className: "flex flex-col gap-3 border-t pt-4", children: [
    /* @__PURE__ */ jsxs(
      "button",
      {
        type: "button",
        ...
        children: [
          open ? /* @__PURE__ */ jsx(TriangleDownMini, {}) : /* @__PURE__ */ jsx(TriangleRightMini, {}),
          /* @__PURE__ */ jsx(Text, { size: "small", weight: "plus", children: t("ADVANCED_TITLE") })
        ]
      }
    ),
    open && /* @__PURE__ */ jsx(ParamMappingsEditor, { rows, onChange, suggestedParams })
  ] });
};
...
const EventRationale = ({ whyKey }) => {
  ...
  if (!why) return null;
  return /* @__PURE__ */ jsxs("div", { className: "flex flex-col gap-1 rounded-lg bg-ui-bg-subtle px-3 py-2", children: [
    /* @__PURE__ */ jsx(Text, { size: "small", weight: "plus", className: "text-ui-fg-subtle", children: t("WHY_LABEL") }),
    /* @__PURE__ */ jsx(Text, { size: "small", className: "text-ui-fg-subtle", children: why }),
    /* @__PURE__ */ jsxs(
      "a",
      {
...
const BuiltinEditDrawer = ({ builtin, open, onOpenChange }) => {
  ...
  return /* @__PURE__ */ jsx(Drawer, { open, onOpenChange, children: /* @__PURE__ */ jsxs(Drawer.Content, { children: [
    /* @__PURE__ */ jsx(Drawer.Header, { children: /* @__PURE__ */ jsx(Heading, { children: t(`BUILTIN.${builtin.builtin_key}.TITLE`, { defaultValue: builtin.builtin_key }) }) }),
    /* @__PURE__ */ jsx(Drawer.Body, { className: "overflow-y-auto p-4", children: /* @__PURE__ */ jsxs("form", { onSubmit: handleSubmit, className: "flex flex-col gap-4", children: [
      /* @__PURE__ */ jsxs("div", { className: "flex flex-col gap-1 rounded-lg bg-ui-bg-subtle px-3 py-2", children: [
        /* @__PURE__ */ jsx("code", { className: "txt-compact-small text-ui-fg-muted", children: builtin.trigger_event }),
        /* @__PURE__ */ jsx(Text, { size: "small", className: "text-ui-fg-subtle", children: t(`BUILTIN.${builtin.builtin_key}.DESC`, { defaultValue: "" }) })
      ] }),
      /* @__PURE__ */ jsx(EventRationale, { whyKey: builtin.builtin_key }),
      /* @__PURE__ */ jsxs("div", { className: "flex flex-col gap-2", children: [
        /* @__PURE__ */ jsx(Label, { htmlFor: "builtin-ga4-event-name", children: t("FIELD_GA4_EVENT_LABEL") }),
        /* @__PURE__ */ jsx(
          Input,
          {
        ...
        /* @__PURE__ */ jsx(Text, { size: "small", className: "text-ui-fg-subtle", children: t("BUILTIN_NOTE") })
      ] }),
      /* @__PURE__ */ jsxs("div", { className: "flex items-center justify-between", children: [
        /* @__PURE__ */ jsxs("div", { children: [
          /* @__PURE__ */ jsx(Label, { htmlFor: "builtin-is-active", children: t("FIELD_ACTIVE_LABEL") }),
          /* @__PURE__ */ jsx(Text, { size: "small", className: "text-ui-fg-subtle", children: t("FIELD_ACTIVE_HELP") })
        ] }),
        /* @__PURE__ */ jsx(Switch, { id: "builtin-is-active", checked: isActive, onCheckedChange: setIsActive })
      ] })
    ] }) }),
    /* @__PURE__ */ jsxs(Drawer.Footer, { className: "flex items-center justify-between", children: [
      /* @__PURE__ */ jsx(Button, { variant: "danger", onClick: handleDelete, isLoading: isPending, children: t("ACTION_DELETE") }),
...
const EventActionsMenu = ({
  ...
  return /* @__PURE__ */ jsx("div", { onClick: (e) => e.stopPropagation(), children: /* @__PURE__ */ jsxs(DropdownMenu, { children: [
    ...
    /* @__PURE__ */ jsxs(DropdownMenu.Content, { children: [
      kind === "generic" && mapping && /* @__PURE__ */ jsxs(Fragment, { children: [
        /* @__PURE__ */ jsxs(DropdownMenu.Item, { className: "gap-x-2", onClick: () => onEdit(mapping), children: [
      ...
      kind === "builtin" && builtin && !builtin.hidden && /* @__PURE__ */ jsxs(Fragment, { children: [
        /* @__PURE__ */ jsxs(DropdownMenu.Item, { className: "gap-x-2", onClick: () => onEditBuiltin(builtin), children: [
          /* @__PURE__ */ jsx(PencilSquare, { className: "text-ui-fg-subtle" }),
          t("ACTION_EDIT")
        ] }),
        /* @__PURE__ */ jsx(DropdownMenu.Separator, {}),
        /* @__PURE__ */ jsxs(DropdownMenu.Item, { className: "gap-x-2 text-ui-fg-error", onClick: handleHideBuiltin, children: [
          /* @__PURE__ */ jsx(Trash, { className: "text-ui-fg-error" }),
          t("ACTION_DELETE")
        ] })
      ] }),
      kind === "builtin" && builtin && builtin.hidden && /* @__PURE__ */ jsxs(DropdownMenu.Item, { className: "gap-x-2", onClick: handleRestoreBuiltin, children: [
        /* @__PURE__ */ jsx(ArrowPath, { className: "text-ui-fg-subtle" }),
        t("ACTION_RESTORE")
      ] }),
      kind === "readonly" && /* @__PURE__ */ jsxs(DropdownMenu.Item, { className: "gap-x-2", onClick: onView, children: [
        /* @__PURE__ */ jsx(EyeMini, { className: "text-ui-fg-subtle" }),
        t("ACTION_VIEW")
      ] })
    ] })
  ] }) });
...
const ChecklistItem = ({ ok, label }) => /* @__PURE__ */ jsxs("div", { className: "flex items-center gap-2", children: [
  ok ? /* @__PURE__ */ jsx(CheckCircleSolid, { className: "text-ui-tag-green-icon" }) : /* @__PURE__ */ jsx(XCircleSolid, { className: "text-ui-tag-red-icon" }),
...
const Ga4ConfigPanel = () => {
  ...
  return /* @__PURE__ */ jsxs(Fragment, { children: [
    /* @__PURE__ */ jsxs("div", { className: "flex items-center justify-end gap-2 border-t px-6 py-4", children: [
      data.debug && /* @__PURE__ */ jsx(Badge, { size: "2xsmall", color: "orange", children: t("CONFIG_DEBUG") }),
      /* @__PURE__ */ jsx(StatusBadge, { color: dispatchActive ? "green" : "grey", children: dispatchActive ? t("CONFIG_DISPATCH_ACTIVE") : t("CONFIG_DISPATCH_INACTIVE") })
    ] }),
    !dispatchActive && /* @__PURE__ */ jsxs("div", { className: "flex flex-col gap-2 border-t px-6 py-3", children: [
      /* @__PURE__ */ jsx(Text, { size: "small", weight: "plus", className: "text-ui-fg-subtle", children: t("CONFIG_CHECKLIST_TITLE") }),
      /* @__PURE__ */ jsx(ChecklistItem, { ok: Boolean(data.measurement_id), label: t("CONFIG_MEASUREMENT_ID") }),
      /* @__PURE__ */ jsx(ChecklistItem, { ok: data.api_secret_set, label: t("CONFIG_CHECKLIST_API_SECRET") }),
      /* @__PURE__ */ jsx(Text, { size: "small", className: "text-ui-fg-muted", children: t("CONFIG_DISPATCH_HINT") })
    ] }),
    /* @__PURE__ */ jsxs("div", { className: "flex items-center justify-between gap-3 border-t px-6 py-3", children: [
      /* @__PURE__ */ jsxs(
        "a",
        {
          href: GA4_ADMIN_URL,
      ...
      dispatchActive ? /* @__PURE__ */ jsx(
        ...
        /* @__PURE__ */ jsx(Tooltip, { content: t("CONFIG_TEST_DISABLED_TOOLTIP"), children: /* @__PURE__ */ jsx("span", { tabIndex: 0, children: /* @__PURE__ */ jsx(Button, { variant: "secondary", size: "small", disabled: true, children: t("CONFIG_TEST_BUTTON") }) }) })
      )
    ] }),
    /* @__PURE__ */ jsx("div", { className: "border-t px-6 py-3", children: /* @__PURE__ */ jsxs(Text, { size: "small", className: "text-ui-fg-muted", children: [
      t("CONFIG_TEST_HELP"),
      " ",
      /* @__PURE__ */ jsx("code", { className: "txt-compact-small", children: "ga4_connection_test" })
    ] }) }),
    result && /* @__PURE__ */ jsx(TestResult, { result })
  ] });
};
const TestResult = ({ result }) => {
  const { t } = useTranslation("ga4Events");
  if (result.valid) {
    return /* @__PURE__ */ jsxs("div", { className: "flex items-center gap-2 border-t bg-ui-bg-subtle px-6 py-3", children: [
      /* @__PURE__ */ jsx(CheckCircleSolid, { className: "text-ui-tag-green-icon" }),
      /* @__PURE__ */ jsx(Text, { size: "small", className: "text-ui-fg-subtle", children: t("CONFIG_TEST_SUCCESS", { event: result.event_name ?? "ga4_connection_test" }) })
    ] });
  }
  return /* @__PURE__ */ jsxs("div", { className: "flex flex-col gap-2 border-t bg-ui-bg-subtle px-6 py-3", children: [
    /* @__PURE__ */ jsxs("div", { className: "flex items-center gap-2", children: [
      /* @__PURE__ */ jsx(XCircleSolid, { className: "text-ui-tag-red-icon" }),
      /* @__PURE__ */ jsx(Text, { size: "small", weight: "plus", className: "text-ui-fg-subtle", children: result.configured ? t("CONFIG_TEST_INVALID") : t("CONFIG_TEST_NOT_CONFIGURED") })
    ] }),
    result.message && /* @__PURE__ */ jsx(Text, { size: "small", className: "text-ui-fg-muted", children: result.message }),
    result.validation_messages.map((m, i) => /* @__PURE__ */ jsxs(Text, { size: "small", className: "text-ui-fg-muted", children: [
      m.fieldPath ? `${m.fieldPath}: ` : "",
      m.description
    ] }, i))
  ] });
};
const Field = ({ label, children }) => /* @__PURE__ */ jsxs("div", { className: "flex flex-col gap-1", children: [
  /* @__PURE__ */ jsx(Text, { size: "small", weight: "plus", className: "text-ui-fg-subtle", children: label }),
  children
] });
const ManagedInfoDrawer = ({
  ...
  registerGa4EventsTranslations(i18n);
  return /* @__PURE__ */ jsx(Drawer, { open, onOpenChange, children: /* @__PURE__ */ jsxs(Drawer.Content, { children: [
    /* @__PURE__ */ jsx(Drawer.Header, { children: /* @__PURE__ */ jsx(Heading, { children: title || t("DETAIL_TITLE") }) }),
    /* @__PURE__ */ jsx(Drawer.Body, { className: "overflow-y-auto p-4", children: /* @__PURE__ */ jsxs("div", { className: "flex flex-col gap-4", children: [
      /* @__PURE__ */ jsx(Field, { label: t("COLUMN_GA4_EVENT"), children: /* @__PURE__ */ jsx("code", { className: "txt-compact-small text-ui-fg-base", children: ga4Event }) }),
      /* @__PURE__ */ jsx(Field, { label: t("COLUMN_MEDUSA_EVENT"), children: /* @__PURE__ */ jsx(Text, { size: "small", className: "text-ui-fg-muted", children: t("MANAGED_MEDUSA_NONE") }) }),
      description && /* @__PURE__ */ jsx(Field, { label: t("FIELD_DESCRIPTION_LABEL"), children: /* @__PURE__ */ jsx(Text, { size: "small", className: "text-ui-fg-subtle", children: description }) }),
      source && /* @__PURE__ */ jsx(Field, { label: t("DETAIL_SOURCE_LABEL"), children: /* @__PURE__ */ jsx(Badge, { size: "2xsmall", color: "grey", children: t(`SOURCE.${source}`) }) }),
      /* @__PURE__ */ jsx(Field, { label: t("DETAIL_WHY_LABEL"), children: /* @__PURE__ */ jsx(Text, { size: "small", className: "text-ui-fg-subtle", children: source ? t(`MANAGED_WHY.${source}`) : t("MANAGED_REASON", { source: "" }) }) }),
      /* @__PURE__ */ jsx(EventRationale, { whyKey: ga4Event })
    ] }) }),
    /* @__PURE__ */ jsxs(Drawer.Footer, { className: "flex items-center justify-between", children: [
      /* @__PURE__ */ jsx(Tooltip, { content: t("DELETE_DISABLED_MANAGED"), children: /* @__PURE__ */ jsx("span", { tabIndex: 0, children: /* @__PURE__ */ jsx(Button, { variant: "danger", disabled: true, children: t("ACTION_DELETE") }) }) }),
      /* @__PURE__ */ jsx(Drawer.Close, { asChild: true, children: /* @__PURE__ */ jsx(Button, { variant: "secondary", children: t("CANCEL") }) })
    ] })
  ] }) });
};
  ...
  return /* @__PURE__ */ jsxs("div", { className: "relative", onKeyDown: handleKeyDown, children: [
    ...
    open && /* @__PURE__ */ jsxs(
      "div",
      {
        ...
        children: [
          filtered.length === 0 && /* @__PURE__ */ jsx("div", { className: "px-3 py-2 text-ui-fg-muted text-sm", children: emptyLabel ?? "Sin resultados" }),
          groups.map((group, gi) => /* @__PURE__ */ jsxs("div", { children: [
            /* @__PURE__ */ jsx("div", { className: "bg-ui-bg-subtle px-3 py-1 font-medium text-ui-fg-muted text-xs uppercase tracking-wide", children: group.label }),
            group.options.map((opt, oi) => {
              ...
              return /* @__PURE__ */ jsxs(
                "button",
                {
                  ...
                  children: [
                    /* @__PURE__ */ jsx("span", { className: "truncate text-ui-fg-base", children: opt.label }),
                    /* @__PURE__ */ jsx("span", { className: "shrink-0 font-mono text-ui-fg-muted text-xs", children: opt.value })
                  ]
                },
                opt.value
              );
...
const MappingEventFields = ({
  ...
  return /* @__PURE__ */ jsxs(Fragment, { children: [
    /* @__PURE__ */ jsxs("div", { className: "flex flex-col gap-2", children: [
      /* @__PURE__ */ jsx(Label, { htmlFor: "medusa_event", children: t("FIELD_MEDUSA_EVENT_LABEL") }),
      /* @__PURE__ */ jsx(
        EventCombobox,
        {
          id: "medusa_event",
    ...
    selectedEvent && /* @__PURE__ */ jsxs("div", { className: "flex flex-col gap-1 rounded-lg bg-ui-bg-subtle px-3 py-2", children: [
      /* @__PURE__ */ jsx(Text, { size: "small", weight: "plus", children: eventTitle(selectedEvent.medusa_event) }),
      /* @__PURE__ */ jsx("code", { className: "txt-compact-small text-ui-fg-muted", children: selectedEvent.medusa_event }),
      /* @__PURE__ */ jsx(Text, { size: "small", className: "text-ui-fg-subtle", children: t(`EVENTS.${eventI18nKey(selectedEvent.medusa_event)}.DESC`, { defaultValue: "" }) })
    ] }),
    selectedEvent && /* @__PURE__ */ jsx(EventRationale, { whyKey: eventI18nKey(selectedEvent.medusa_event) }),
    /* @__PURE__ */ jsxs("div", { className: "flex flex-col gap-2", children: [
      /* @__PURE__ */ jsx(Label, { htmlFor: "ga4_event_name", children: t("FIELD_GA4_EVENT_LABEL") }),
      /* @__PURE__ */ jsx(
        Input,
        {
          id: "ga4_event_name",
      ...
      /* @__PURE__ */ jsx(Text, { size: "small", className: "text-ui-fg-subtle", children: t("FIELD_GA4_EVENT_HELP") })
    ] })
  ] });
};
const MappingCreateDrawer = () => {
  ...
  const [paramRows, setParamRows] = useState([emptyParamRow()]);
...
const MappingEditDrawer = ({ mapping, open, onOpenChange }) => {
  ...
  const [paramRows, setParamRows] = useState(toParamRows(mapping.param_mappings));
  const selectedEvent = useMemo(
    () => events.find((e) => e.medusa_event === medusaEvent),
    [events, medusaEvent]
  );
  ...
  return /* @__PURE__ */ jsx(Drawer, { open, onOpenChange, children: /* @__PURE__ */ jsxs(Drawer.Content, { children: [
    ...
    /* @__PURE__ */ jsx(Drawer.Body, { className: "overflow-y-auto p-4", children: /* @__PURE__ */ jsxs("form", { onSubmit: handleSubmit, className: "flex flex-col gap-4", children: [
      ...
      /* @__PURE__ */ jsxs("div", { className: "flex items-center justify-between", children: [
        /* @__PURE__ */ jsxs("div", { children: [
          /* @__PURE__ */ jsx(Label, { htmlFor: "edit-is-active", children: t("FIELD_ACTIVE_LABEL") }),
          /* @__PURE__ */ jsx(Text, { size: "small", className: "text-ui-fg-subtle", children: t("FIELD_ACTIVE_HELP") })
        ] }),
        /* @__PURE__ */ jsx(Switch, { id: "edit-is-active", checked: isActive, onCheckedChange: setIsActive })
      ] }),
      /* @__PURE__ */ jsx(
        AdvancedParams,
        {
    ...
    /* @__PURE__ */ jsxs(Drawer.Footer, { className: "flex items-center justify-between", children: [
      /* @__PURE__ */ jsx(Button, { variant: "danger", onClick: handleDelete, isLoading: isDeleting, children: t("ACTION_DELETE") }),
      /* @__PURE__ */ jsxs("div", { className: "flex items-center gap-2", children: [
        /* @__PURE__ */ jsx(Drawer.Close, { asChild: true, children: /* @__PURE__ */ jsx(Button, { variant: "secondary", children: t("CANCEL") }) }),
        /* @__PURE__ */ jsx(Button, { onClick: handleSubmit, isLoading: isPending, children: t("EDIT_SUBMIT") })
      ] })
  ...
  const columns = useMemo(
    () => [
      columnHelper.display({
        ...
        cell: ({ row }) => /* @__PURE__ */ jsxs(
          "button",
          {
            ...
            children: [
              /* @__PURE__ */ jsx("span", { className: "font-medium text-ui-fg-interactive", children: row.original.title }),
              /* @__PURE__ */ jsx("span", { className: "text-ui-fg-muted txt-compact-small", children: t(`STAGE.${row.original.stage}`) })
            ]
          }
        )
      }),
      columnHelper.display({
        ...
        cell: ({ row }) => /* @__PURE__ */ jsx(Tooltip, { content: t(`TYPE_HINT.${row.original.kind}`), children: /* @__PURE__ */ jsx(Badge, { size: "2xsmall", color: KIND_BADGE_COLOR[row.original.kind], children: t(`TYPE.${row.original.kind}`) }) })
      }),
      columnHelper.display({
        id: "medusa_event",
        header: t("COLUMN_MEDUSA_EVENT"),
        cell: ({ row }) => row.original.medusa_event ? /* @__PURE__ */ jsx("code", { className: "text-ui-fg-subtle txt-compact-small", children: row.original.medusa_event }) : /* @__PURE__ */ jsx("span", { className: "text-ui-fg-muted", children: "—" })
      }),
      columnHelper.display({
        id: "ga4_event",
        header: t("COLUMN_GA4_EVENT"),
        cell: ({ row }) => /* @__PURE__ */ jsx("code", { className: "text-ui-fg-subtle txt-compact-small", children: row.original.ga4_event_name })
      }),
      columnHelper.display({
        id: "status",
        ...
        cell: ({ row }) => {
          if (row.original.kind === "readonly") {
            return /* @__PURE__ */ jsxs("div", { className: "flex items-center gap-2", children: [
              /* @__PURE__ */ jsx(StatusBadge, { color: "green", children: t("STATUS_TRACKED") }),
              row.original.source && /* @__PURE__ */ jsx(Text, { size: "small", className: "text-ui-fg-muted", children: t(`SOURCE.${row.original.source}`) })
            ] });
          }
          if (row.original.kind === "builtin" && row.original.hidden) {
            return /* @__PURE__ */ jsx(StatusBadge, { color: "red", children: t("STATUS_REMOVED") });
          }
          return /* @__PURE__ */ jsx(StatusBadge, { color: row.original.is_active ? "green" : "grey", children: row.original.is_active ? t("STATUS_ACTIVE") : t("STATUS_INACTIVE") });
        }
      }),
      columnHelper.display({
        id: "actions",
    ...
    /* @__PURE__ */ jsx(Container, { className: "p-0", children: /* @__PURE__ */ jsxs(DataTable, { instance: table, children: [
      /* @__PURE__ */ jsxs(
        DataTable.Toolbar,
        {
          ...
          filterBarContent: hasActiveStatusFilter ? /* @__PURE__ */ jsx(Button, { variant: "transparent", size: "small", onClick: () => setFiltering({}), children: t("FILTER_CLEAR_ALL") }) : void 0,
          children: [
            /* @__PURE__ */ jsxs("div", { className: "flex items-center gap-x-2", children: [
              /* @__PURE__ */ jsx(Heading, { children: t("TITLE") }),
              /* @__PURE__ */ jsx(Badge, { size: "2xsmall", children: "v1.0.0" })
            ] }),
            /* @__PURE__ */ jsxs("div", { className: "flex items-center gap-2", children: [
              /* @__PURE__ */ jsx(DataTable.Search, { placeholder: t("SEARCH_PLACEHOLDER") }),
              /* @__PURE__ */ jsx(MappingCreateDrawer, {})
            ] })
          ]
        }
      ),
      filtered.length > 0 || isPending ? /* @__PURE__ */ jsxs(Fragment, { children: [
...
const Ga4ConfigPage = () => {
  ...
  return /* @__PURE__ */ jsxs(Fragment, { children: [
    /* @__PURE__ */ jsxs(Container, { className: "p-0", children: [
      /* @__PURE__ */ jsx("div", { className: "flex items-center justify-between px-6 py-4", children: /* @__PURE__ */ jsx(Heading, { children: t("CONFIG_TITLE") }) }),
      /* @__PURE__ */ jsx(Ga4ConfigPanel, {})
    ] }),
    /* @__PURE__ */ jsxs(Container, { children: [
      ...
      /* @__PURE__ */ jsxs(Text, { className: "text-ui-fg-subtle", children: [
        ...
        " ",
        /* @__PURE__ */ jsx("code", { children: "extension:ga4" }),
        ". Ese editor pisa siempre a la fila legacy",
        " ",
        /* @__PURE__ */ jsx("code", { children: "ga4_settings" }),
