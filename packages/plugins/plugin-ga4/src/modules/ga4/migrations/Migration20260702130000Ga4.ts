 ...
 */
export class Migration20260702130000Ga4 extends Migration {
  override async up(): Promise<void> {
    this.addSql(
      `alter table if exists "ga4_builtin_setting" add column if not exists "hidden" boolean not null default false;`
    );
  }
