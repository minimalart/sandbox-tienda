...
const SalesChannelMultiSelect = ({ value, onChange, label, help }) => {
  ...
  return /* @__PURE__ */ jsxRuntime.jsxs("div", { className: "flex flex-col gap-2", children: [
    label && /* @__PURE__ */ jsxRuntime.jsx(ui.Label, { size: "xsmall", children: label }),
    help && /* @__PURE__ */ jsxRuntime.jsx(ui.Text, { size: "xsmall", className: "text-ui-fg-subtle", children: help }),
    /* @__PURE__ */ jsxRuntime.jsx("div", { className: "flex max-h-56 flex-col gap-2 overflow-y-auto", children: channels.map((c) => /* @__PURE__ */ jsxRuntime.jsxs("label", { className: "flex items-center gap-2", children: [
...
const CreateVideoDrawer = ({ open, onClose }) => {
  const { t, i18n } = reactI18next.useTranslation("videos");
  registerVideosTranslations(i18n);
  const [activeTab, setActiveTab] = react.useState("upload");
  const [searchQuery, setSearchQuery] = react.useState("");
  const [selectedVimeoId, setSelectedVimeoId] = react.useState("");
  const [selectedVimeoVideo, setSelectedVimeoVideo] = react.useState(null);
  ...
  return /* @__PURE__ */ jsxRuntime.jsx(ui.Drawer, { open, onOpenChange: onClose, children: /* @__PURE__ */ jsxRuntime.jsxs(ui.Drawer.Content, { className: "flex h-full flex-col", children: [
    /* @__PURE__ */ jsxRuntime.jsx(ui.Drawer.Header, { children: /* @__PURE__ */ jsxRuntime.jsx(ui.Heading, { children: t("ADD_VIDEO") }) }),
    /* @__PURE__ */ jsxRuntime.jsxs(ui.Drawer.Body, { className: "flex flex-1 flex-col gap-6 overflow-y-auto", children: [
      /* @__PURE__ */ jsxRuntime.jsxs(ui.Tabs, { value: activeTab, onValueChange: setActiveTab, children: [
        /* @__PURE__ */ jsxRuntime.jsxs(ui.Tabs.List, { children: [
          /* @__PURE__ */ jsxRuntime.jsx(ui.Tabs.Trigger, { value: "upload", children: t("TAB_UPLOAD") }),
          /* @__PURE__ */ jsxRuntime.jsx(ui.Tabs.Trigger, { value: "link", children: t("TAB_LINK") })
        ] }),
        /* @__PURE__ */ jsxRuntime.jsx(ui.Tabs.Content, { value: "upload", className: "flex flex-col gap-3 mt-4", children: /* @__PURE__ */ jsxRuntime.jsxs("div", { className: "flex flex-col gap-3", children: [
          /* @__PURE__ */ jsxRuntime.jsxs("div", { className: "flex flex-col items-center justify-center p-8 border-2 border-dashed border-ui-border-base rounded-lg bg-ui-bg-subtle", children: [
            /* @__PURE__ */ jsxRuntime.jsx(
              "input",
              {
                type: "file",
            ...
            /* @__PURE__ */ jsxRuntime.jsxs("label", { htmlFor: "video-file", className: "cursor-pointer text-center w-full", children: [
              /* @__PURE__ */ jsxRuntime.jsx(ui.Text, { className: "text-ui-fg-subtle mb-2", children: selectedFile ? selectedFile.name : t("FILE_DROP_PLACEHOLDER") }),
              /* @__PURE__ */ jsxRuntime.jsx(ui.Text, { className: "text-xs text-ui-fg-muted", children: selectedFile ? `${(selectedFile.size / 1024 / 1024).toFixed(2)} MB` : t("FILE_FORMATS_HINT") })
            ] })
          ] }),
          selectedFile && /* @__PURE__ */ jsxRuntime.jsx(ui.StatusBadge, { color: "green", children: t("FILE_READY", { name: selectedFile.name }) }),
          /* @__PURE__ */ jsxRuntime.jsxs("div", { children: [
            /* @__PURE__ */ jsxRuntime.jsx(ui.Label, { htmlFor: "upload-title", children: t("LABEL_TITLE") }),
            /* @__PURE__ */ jsxRuntime.jsx(
              ui.Input,
              {
                id: "upload-title",
          ...
          isUploading && /* @__PURE__ */ jsxRuntime.jsxs("div", { className: "flex flex-col gap-2", children: [
            /* @__PURE__ */ jsxRuntime.jsx(ui.Text, { className: "text-sm", children: t("UPLOADING_PROGRESS", { progress: uploadProgress }) }),
            /* @__PURE__ */ jsxRuntime.jsx("div", { className: "w-full bg-ui-bg-subtle rounded-full h-2", children: /* @__PURE__ */ jsxRuntime.jsx(
              "div",
              {
        ...
        /* @__PURE__ */ jsxRuntime.jsx(ui.Tabs.Content, { value: "link", className: "flex flex-col gap-3 mt-4", children: /* @__PURE__ */ jsxRuntime.jsxs("div", { className: "flex flex-col gap-3", children: [
          ...
          /* @__PURE__ */ jsxRuntime.jsxs("div", { className: "flex flex-col gap-2 max-h-[300px] overflow-y-auto border border-ui-border-base rounded-lg p-2", children: [
            isLoadingVimeo && /* @__PURE__ */ jsxRuntime.jsx(ui.Text, { className: "text-ui-fg-subtle p-4", children: t("LOADING_VIMEO_VIDEOS") }),
            vimeoVideos && vimeoVideos.data && vimeoVideos.data.length > 0 && /* @__PURE__ */ jsxRuntime.jsxs("div", { className: "flex flex-col gap-2", children: [
              /* @__PURE__ */ jsxRuntime.jsx(ui.Label, { children: t("SELECT_A_VIDEO") }),
              /* @__PURE__ */ jsxRuntime.jsx("div", { className: "flex flex-col gap-2", children: vimeoVideos.data.map((video) => {
                var _a, _b, _c;
                return /* @__PURE__ */ jsxRuntime.jsx(
                  "button",
                  {
                    ...
                    children: /* @__PURE__ */ jsxRuntime.jsxs("div", { className: "flex items-start gap-3", children: [
                      ((_c = (_b = (_a = video.pictures) == null ? void 0 : _a.sizes) == null ? void 0 : _b[0]) == null ? void 0 : _c.link) && /* @__PURE__ */ jsxRuntime.jsx(
                        "img",
                        {
                      ...
                      /* @__PURE__ */ jsxRuntime.jsxs("div", { className: "flex-1 min-w-0", children: [
                        /* @__PURE__ */ jsxRuntime.jsx(ui.Text, { className: "font-medium truncate", children: video.name }),
                        /* @__PURE__ */ jsxRuntime.jsx(ui.Text, { className: "text-xs text-ui-fg-subtle truncate", children: video.description || t("NO_DESCRIPTION") }),
                        /* @__PURE__ */ jsxRuntime.jsx("div", { className: "flex items-center gap-2 mt-1", children: /* @__PURE__ */ jsxRuntime.jsxs(ui.Badge, { size: "small", children: [
                          video.duration,
                          "s"
                        ] }) })
                      ] })
            ...
            vimeoVideos && vimeoVideos.data && vimeoVideos.data.length === 0 && /* @__PURE__ */ jsxRuntime.jsx("div", { className: "flex flex-col items-center justify-center p-8", children: /* @__PURE__ */ jsxRuntime.jsx(ui.Text, { className: "text-ui-fg-subtle mb-4 text-center", children: t("NO_VIMEO_VIDEOS") }) })
          ] }),
          selectedVimeoId && /* @__PURE__ */ jsxRuntime.jsxs("div", { className: "border-t pt-3 mt-3", children: [
            /* @__PURE__ */ jsxRuntime.jsx(ui.Heading, { level: "h3", className: "mb-4", children: t("VIDEO_DETAILS") }),
            /* @__PURE__ */ jsxRuntime.jsxs("form", { onSubmit: handleSubmit, className: "flex flex-col gap-4", children: [
              /* @__PURE__ */ jsxRuntime.jsxs("div", { children: [
                /* @__PURE__ */ jsxRuntime.jsx(ui.Label, { htmlFor: "title", children: t("LABEL_TITLE") }),
                /* @__PURE__ */ jsxRuntime.jsx(
                  ui.Input,
                  {
                    id: "title",
              ...
              /* @__PURE__ */ jsxRuntime.jsxs("div", { children: [
                /* @__PURE__ */ jsxRuntime.jsx(ui.Label, { htmlFor: "description", children: t("LABEL_DESCRIPTION") }),
                /* @__PURE__ */ jsxRuntime.jsx(
                  ui.Textarea,
                  {
                    id: "description",
              ...
              /* @__PURE__ */ jsxRuntime.jsx(ui.StatusBadge, { color: "green", children: t("SELECTED_VIMEO_ID", { id: selectedVimeoId }) })
            ] })
          ] })
        ] }) })
      ] }),
    ...
    /* @__PURE__ */ jsxRuntime.jsx(ui.Drawer.Footer, { children: /* @__PURE__ */ jsxRuntime.jsxs("div", { className: "flex items-center gap-2 justify-end w-full", children: [
      /* @__PURE__ */ jsxRuntime.jsx(ui.Button, { variant: "secondary", onClick: onClose, children: t("CANCEL") }),
      activeTab === "link" && /* @__PURE__ */ jsxRuntime.jsx(
        ui.Button,
        {
          variant: "primary",
...
const ProductSelector = ({ value, onChange }) => {
  const { t } = reactI18next.useTranslation("videos");
  ...
  return /* @__PURE__ */ jsxRuntime.jsxs("div", { className: "flex flex-col gap-3", children: [
    ...
    value.length === 0 ? /* @__PURE__ */ jsxRuntime.jsx(ui.Text, { size: "small", className: "text-ui-fg-muted", children: t("PRODUCTS_EMPTY", { defaultValue: "No products linked yet." }) }) : /* @__PURE__ */ jsxRuntime.jsx(
      core.DndContext,
      {
        sensors,
...
const EditVideoDrawer = ({ videoId, open, onClose }) => {
  ...
  const [showInCarousel, setShowInCarousel] = react.useState(true);
  const [posterUrl, setPosterUrl] = react.useState("");
  const [isUploadingPoster, setIsUploadingPoster] = react.useState(false);
  const [sortOrder, setSortOrder] = react.useState(0);
  const [salesChannelIds, setSalesChannelIds] = react.useState([]);
  const [productIds, setProductIds] = react.useState([]);
  const originalProductIdsRef = react.useRef([]);
  ...
  if (isLoading) {
    return /* @__PURE__ */ jsxRuntime.jsx(ui.Drawer, { open, onOpenChange: onClose, children: /* @__PURE__ */ jsxRuntime.jsx(ui.Drawer.Content, { children: /* @__PURE__ */ jsxRuntime.jsx(ui.Drawer.Header, { children: /* @__PURE__ */ jsxRuntime.jsx(ui.Heading, { children: t("LOADING") }) }) }) });
  }
  return /* @__PURE__ */ jsxRuntime.jsx(ui.Drawer, { open, onOpenChange: onClose, children: /* @__PURE__ */ jsxRuntime.jsxs(ui.Drawer.Content, { className: "flex h-full flex-col", children: [
    /* @__PURE__ */ jsxRuntime.jsx(ui.Drawer.Header, { children: /* @__PURE__ */ jsxRuntime.jsx(ui.Heading, { children: t("EDIT_VIDEO") }) }),
    /* @__PURE__ */ jsxRuntime.jsxs(ui.Drawer.Body, { className: "flex flex-1 flex-col gap-6 overflow-y-auto", children: [
      (video == null ? void 0 : video.thumbnail_url) && /* @__PURE__ */ jsxRuntime.jsxs("div", { className: "flex flex-col gap-2", children: [
        /* @__PURE__ */ jsxRuntime.jsx(ui.Label, { children: t("PREVIEW") }),
        /* @__PURE__ */ jsxRuntime.jsx(
          "img",
          {
        ...
        /* @__PURE__ */ jsxRuntime.jsxs("div", { className: "flex items-center gap-2", children: [
          /* @__PURE__ */ jsxRuntime.jsx(ui.Badge, { size: "small", children: t("VIMEO_ID_BADGE", { id: video.vimeo_id }) }),
          /* @__PURE__ */ jsxRuntime.jsx(ui.StatusBadge, { color: video.status === "available" ? "green" : "blue", children: t(`STATUS_${(video.status || "unknown").toUpperCase()}`, { defaultValue: video.status }) })
        ] })
      ] }),
      /* @__PURE__ */ jsxRuntime.jsxs("form", { onSubmit: handleSubmit, className: "flex flex-col gap-4", children: [
        /* @__PURE__ */ jsxRuntime.jsxs("div", { children: [
        ...
        /* @__PURE__ */ jsxRuntime.jsxs("div", { className: "flex items-center justify-between", children: [
          /* @__PURE__ */ jsxRuntime.jsx(ui.Label, { htmlFor: "is_active", children: t("TABLE_COL_ACTIVE") }),
          /* @__PURE__ */ jsxRuntime.jsx(ui.Switch, { id: "is_active", checked: isActive, onCheckedChange: setIsActive })
        ] }),
        /* @__PURE__ */ jsxRuntime.jsxs("div", { className: "flex items-center justify-between", children: [
          /* @__PURE__ */ jsxRuntime.jsxs("div", { className: "flex flex-col", children: [
            /* @__PURE__ */ jsxRuntime.jsx(ui.Label, { htmlFor: "show_in_carousel", children: t("LABEL_SHOW_IN_CAROUSEL", { defaultValue: "Mostrar en el carrousel de la home" }) }),
            /* @__PURE__ */ jsxRuntime.jsx(ui.Text, { size: "small", className: "text-ui-fg-subtle", children: t("SHOW_IN_CAROUSEL_HELP", {
        ...
        /* @__PURE__ */ jsxRuntime.jsxs("div", { className: "flex flex-col gap-2", children: [
          /* @__PURE__ */ jsxRuntime.jsx(ui.Label, { children: t("LABEL_POSTER", { defaultValue: "Miniatura (poster)" }) }),
          /* @__PURE__ */ jsxRuntime.jsx(ui.Text, { size: "small", className: "text-ui-fg-subtle", children: t("POSTER_HELP", {
            defaultValue: "Se muestra en el front mientras el video carga. Si no elegís una, se usa la de Vimeo."
          }) }),
          (posterUrl || (video == null ? void 0 : video.thumbnail_url)) && /* @__PURE__ */ jsxRuntime.jsx(
            "img",
            {
        ...
        /* @__PURE__ */ jsxRuntime.jsxs("div", { children: [
          /* @__PURE__ */ jsxRuntime.jsx(ui.Label, { htmlFor: "sort_order", children: t("TABLE_COL_SORT_ORDER") }),
          /* @__PURE__ */ jsxRuntime.jsx(
            ui.Input,
            {
              id: "sort_order",
      ...
      /* @__PURE__ */ jsxRuntime.jsxs("div", { className: "flex flex-col gap-3 border-t pt-4", children: [
        /* @__PURE__ */ jsxRuntime.jsx(ui.Heading, { level: "h3", children: t("LINKED_PRODUCTS") }),
    ...
    () => [
      columnHelper.accessor("title", {
        ...
        cell: ({ row }) => {
          ...
          return /* @__PURE__ */ jsxRuntime.jsxs("div", { className: "flex items-center gap-3", children: [
            video.thumbnail_url ? /* @__PURE__ */ jsxRuntime.jsx(
              "img",
              {
                src: video.thumbnail_url,
                alt: video.title,
            ...
            ) : /* @__PURE__ */ jsxRuntime.jsx("div", { className: "w-16 h-10 bg-ui-bg-subtle rounded flex items-center justify-center", children: /* @__PURE__ */ jsxRuntime.jsx(
              "svg",
              {
            ...
            /* @__PURE__ */ jsxRuntime.jsxs("div", { children: [
              /* @__PURE__ */ jsxRuntime.jsx(ui.Text, { className: "font-medium", children: video.title }),
              video.description ? /* @__PURE__ */ jsxRuntime.jsx(ui.Text, { className: "text-xs text-ui-fg-subtle line-clamp-1", children: video.description }) : null
            ] })
          ] });
        }
      }),
      columnHelper.accessor("status", {
        ...
        cell: ({ getValue }) => {
          ...
          return /* @__PURE__ */ jsxRuntime.jsx(ui.StatusBadge, { color: getStatusColor(status), children: t(`STATUS_${(status || "unknown").toUpperCase()}`, { defaultValue: status }) });
        }
      }),
      columnHelper.accessor("duration", {
        header: t("TABLE_COL_DURATION"),
        cell: ({ getValue }) => /* @__PURE__ */ jsxRuntime.jsx(ui.Text, { className: "text-sm", children: formatDuration(getValue()) })
      }),
      columnHelper.accessor("is_active", {
        header: t("TABLE_COL_ACTIVE"),
        cell: ({ getValue }) => /* @__PURE__ */ jsxRuntime.jsx(ui.StatusBadge, { color: getValue() ? "green" : "grey", children: getValue() ? t("YES") : t("NO") })
      }),
      columnHelper.accessor("sort_order", {
        header: t("TABLE_COL_SORT_ORDER"),
        cell: ({ getValue }) => /* @__PURE__ */ jsxRuntime.jsx(ui.Text, { className: "text-sm", children: getValue() })
      }),
    ...
    /* @__PURE__ */ jsxRuntime.jsx(ui.Container, { className: "p-0", children: /* @__PURE__ */ jsxRuntime.jsxs(ui.DataTable, { instance: table, children: [
      /* @__PURE__ */ jsxRuntime.jsxs(ui.DataTable.Toolbar, { className: "flex items-center justify-between px-6 py-4", children: [
        /* @__PURE__ */ jsxRuntime.jsxs("div", { className: "flex items-center gap-x-2", children: [
          ...
          /* @__PURE__ */ jsxRuntime.jsxs(ui.Badge, { size: "2xsmall", children: [
            "v",
            PLUGIN_VERSION
          ] })
        ] }),
        /* @__PURE__ */ jsxRuntime.jsx(ui.Button, { variant: "secondary", size: "small", onClick: () => setIsCreateDrawerOpen(true), children: t("CREATE_BUTTON") })
      ] }),
      ...
      ] }) : /* @__PURE__ */ jsxRuntime.jsxs("div", { className: "flex flex-col items-center justify-center gap-1 border-t py-12", children: [
        /* @__PURE__ */ jsxRuntime.jsx(ui.Text, { className: "text-ui-fg-subtle", children: t("TABLE_EMPTY_TITLE") }),
        /* @__PURE__ */ jsxRuntime.jsx(ui.Text, { className: "text-sm text-ui-fg-muted", children: t("TABLE_EMPTY_SUBTITLE") })
      ] })
    ] }) }),
    /* @__PURE__ */ jsxRuntime.jsx(CreateVideoDrawer, { open: isCreateDrawerOpen, onClose: () => setIsCreateDrawerOpen(false) }),
    /* @__PURE__ */ jsxRuntime.jsx(
      EditVideoDrawer,
      {
        videoId: editVideoId,
...
const VideosPage = () => {
  const { i18n } = reactI18next.useTranslation("videos");
  registerVideosTranslations(i18n);
...
const CredentialsPage = () => /* @__PURE__ */ jsxRuntime.jsx(reactRouterDom.Navigate, { to: "/settings/site-credentials#videos", replace: true });
