...
export const EMAIL_TEMPLATE_VARIABLES: Record<string, EmailTemplateVariable[]> = {
  ...
  'order-transfer-request': [
    { name: 'subject', description: 'Asunto del email (usado en el <title>)' },
    { name: 'link_vinculacion', description: 'URL que confirma la vinculación del pedido a la cuenta' },
    { name: 'display_id', description: 'Número de pedido a mostrar' },
    { name: 'order_date', description: 'Fecha del pedido (ISO; se formatea en la plantilla)' },
    { name: 'claiming_email', description: 'Email de la cuenta que reclama. Sólo si la solicitud pidió cambiarlo' },
    { name: 'logo_url', description: 'URL absoluta del logo del CDE' },
    { name: 'cde_display_name', description: 'Nombre del CDE / tienda' },
    { name: 'sales_channel_name', description: 'Nombre del canal de venta' },
    { name: 'primary_color', description: 'Color primario del tenant (hex)' },
  ...
  'order-notification-admin': [
    ...
    { name: 'order_items', description: 'Array de items {title, quantity, unit_price_formatted, line_total_formatted, thumbnail, color_label, color_hex, stock_status, stock_status_label, stock_status_color, stock_available_label}. Los campos stock_* SÓLO viajan acá (mail admin), nunca al mail del cliente' },
    { name: 'subtotal_formatted', description: 'Subtotal formateado' },
    { name: 'discounts', description: 'Array de descuentos {label, amount_formatted, makes_free}' },
    { name: 'shipping_display', description: 'Costo de envío a mostrar ("Gratis" o "$ x")' },
    { name: 'total', description: 'Total del pedido formateado' },
    ...
    { name: 'is_store_pickup', description: 'True cuando la orden es de retiro en tienda (gatea todo el bloque)' },
    { name: 'pickup_store', description: 'Sucursal elegida {name, address, phone, hours[], map_url}. Ausente si no se pudo leer' },
    { name: 'pickup_items', description: 'Disponibilidad por línea en la sucursal elegida {title, variant_title, quantity, available, available_label, status, status_label, status_color}. Se mantiene por compatibilidad con plantillas ya editadas a mano' },
    { name: 'pickup_has_stock_issues', description: 'True si alguna línea no llega a la cantidad pedida en esa sucursal' },
    { name: 'stock_location_name', description: 'Nombre de la sucursal/depósito cuyo stock se evaluó en order_items (retiro elegido, o la ubicación de la shipping option del envío). Ausente si no se pudo resolver ninguna' },
    { name: 'has_stock_issues', description: 'True si alguna línea de order_items quedó insufficient o none, para CUALQUIER orden (no sólo retiro)' },
    { name: 'year', description: 'Año actual para el footer' },
  ],
