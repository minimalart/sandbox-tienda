import type { ProductImporter } from '../../../lib/catalog/types';
 ...
 * desde el importador.
 */
export type { SourceType, PlatformSourceType } from '../../../lib/catalog/source-type';
export { isSalesChannelSource } from '../../../lib/catalog/source-type';

import { isSalesChannelSource } from '../../../lib/catalog/source-type';
import type { PlatformSourceType, SourceType } from '../../../lib/catalog/source-type';
