...
import storeImporterDescriptors from '../app-settings/descriptors/fragments/catalog-import';
 ...
 * TODAS las tiendas en una sola pasada — ver la nota de `descriptors/fragments/catalog-import.ts`.
 *
 * SERVER-ONLY: importa `resolve.ts`, que lee `process.env` y descifra. El bundle
 * del admin importa `descriptors/fragments/catalog-import`, nunca esto.
 */

export const STORE_IMPORTER_SETTINGS_NAMESPACE = 'extension:multistore';
