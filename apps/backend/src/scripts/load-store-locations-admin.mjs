...
const DEMO_LOCATIONS = [
  { name: 'Casa Central — Buenos Aires', store_type: 'point_of_sale', code: 'CC-BA', province: 'CABA', city: 'CABA', street: 'Av. Corrientes 1234', lat: '-34.6037', lng: '-58.3816', phone: '+54 11 4321-1000', whatsapp: '+54 9 11 4321-1000', email: 'casacentral@ejemplo.com.ar', business_hours: weekdayHours('09:00', '18:00'), is_visible: true },
  ...
  { name: 'Sucursal Palermo', store_type: 'point_of_sale', code: 'SUC-PAL', province: 'CABA', city: 'CABA', street: 'Av. Santa Fe 3500', lat: '-34.5889', lng: '-58.4306', phone: '+54 11 4823-1100', whatsapp: '+54 9 11 4823-1100', email: 'palermo@ejemplo.com.ar', business_hours: weekdayHours('10:00', '20:00', true), is_visible: true },
  { name: 'Sucursal Belgrano', store_type: 'point_of_sale', code: 'SUC-BEL', province: 'CABA', city: 'CABA', street: 'Av. Cabildo 2200', lat: '-34.5627', lng: '-58.4566', phone: '+54 11 4781-1200', whatsapp: '+54 9 11 4781-1200', email: 'belgrano@ejemplo.com.ar', business_hours: weekdayHours('10:00', '20:00', true), is_visible: true },
