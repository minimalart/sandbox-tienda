// Config de Sentry para el runtime Node del servidor (RSC, route handlers, SSR).
...
if (dsn && enabled) {
  Sentry.init({
    ...
    // No enviar datos personales (IP, cookies, headers de request) por defecto.
    sendDefaultPii: false,
    // Tracing apagado por defecto; subir por entorno si se necesita.
