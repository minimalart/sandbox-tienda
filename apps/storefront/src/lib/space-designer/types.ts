// Storefront wire DTOs. Kept compatible with the optional plugin by contract.test.ts.
...
export type SpaceAsset = {
  ...
  shape?: 'box' | 'cylinder';
  color?: string;
  model?: 'table' | 'desk' | 'hex-table-set' | 'shelving' | 'cabinet' | 'chair' | 'computer' | 'projector' | 'robotics-kit';
  accent_color?: string;
